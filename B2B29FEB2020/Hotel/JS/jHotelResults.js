$(document).ready(function () {
        ...
        success: function (data) {
            ...
            if (response != null) {
                ...
                for (var i = 0; i < response.length; i++) {
                    if (response[i].HtlError == null) {
                       ...
                       // pkgHtml += "<div class='clear'></div>";
                        ...
                        pkgHtml += "<div class='lft w75'>";
                        pkgHtml += "<span class='lft htlServisess1 w100'><p class='aminites'>";
                        pkgHtml += response[i].HotelServices;
                        pkgHtml += "</p></span>";

                        pkgHtml += "<span class='rgt colorwhite'>" + response[i].Provider + "</span>";

                        pkgHtml += "<span class='w25 htlServisess1 lft'> ";
                        if (response[i].Provider == "ZUMATA" || response[i].Provider == "TG")
                            {
                ...
                for (var j = 0; j < loclist.length; j++) {
                    var locsubstr = "";
                    if (loclist[j].length > 31)
                        locsubstr = loclist[j].substring(0, 31);
                    else
                        locsubstr = loclist[j];
                    if (j <= 10) {
    ...
    $("#divhtldtls").delegate('.viewdtl', 'click', function (e) {
