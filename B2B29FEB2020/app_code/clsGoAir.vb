...
Public Class clsGoAir
    ...
    Public Function GetAvailability(ByVal sGUID As String, ByVal CorporateId As String, ByVal UserId As String, ByVal Password As String, ByVal Trip As String, ByVal TourType As String, ByVal sOrigin As String, _
                                      ...
                                      ByVal dTotalNo_Adt As Decimal, ByVal dTotalNo_Chd As Decimal, ByVal dTotalNo_Inf As Decimal, ByVal sCabin As String, ByVal IPAddress As String, ByVal sAgentId As String, ByVal sDistr As String, ByVal searchValue As String, ByVal tCnt As Integer, ByVal Ft As String, ByVal TrackId As String) As DataTable
        ...
        If myTALoginResult = True Then
            ...
            dtTemp = GetDataTable(sGetFareQuote, dTotalNo_Adt, dTotalNo_Chd, dTotalNo_Inf, Trip, TourType, sAgentId, sDistr, searchValue, sOrigin, sDestination, tCnt, Ft, TrackId, sGUID)
        End If
        Return dtTemp
    End Function
    ...
    Private Function BookRequest(ByVal sIATA As String, ByVal sGUID As String, ByVal sAddress1 As String, _
        ...
        Dim sPromoCode As String = "G8REO1260"
        Dim myXML As String = ""
    ...
    Public Function GetBookingDetails(ByVal sGUID As String, ByVal sAddress1 As String, _
        ...
        If dTotalAmount = dAmount Then
            ...
            dtSaveResBOXml = GetPayBOXML(sGUID, dtGetCommSumm, dTotalAmount, sAddress1, sAddress2, sCity, sCountry, sPostal, custinfo, sFareInformationID, sCriteria, sGetSummary, CorporateId, UserId)
    ...
    Private Function AddPaymentXML(ByVal sAddress1 As String, _
                                      ...
                                      ByVal sLastName_Adt As String, ByVal sFirstName_Adt As String, ByVal IATANumber As String, ByVal UserId As String) As String
        Dim myXML As String = ""
        myXML += "<?xml version='1.0' encoding='UTF-8'?>"
        myXML += "<Payments>"
        myXML += "<Payment>"
        ...
        myXML += "<UserID>" & UserId & "</UserID>"
        myXML += "<IataNumber>" & IATANumber & "</IataNumber>"
        myXML += "<GcxID/>"
        myXML += "<GcxOptOption/>"
    ...
    Private Function GetPayBOXML(ByVal sGUID As String, ByVal dtTemp As DataTable, ByVal dTotalPaidAmt As Decimal, ByVal sAddress1 As String, _
                                      ...
                                      ByRef custinfo As Hashtable, ByVal sFareInformationID As String, ByVal BookReq As String, ByVal BookRes As String, ByVal IATANumber As String, ByVal UserId As String) As DataTable
        ...
        sPayXML = AddPaymentXML(sAddress1, sAddress2, dTotalPaidAmt, sCity, sCountry, sPaidDate, sPostal, sVoucherNo, sLName, sFName, IATANumber, UserId)
