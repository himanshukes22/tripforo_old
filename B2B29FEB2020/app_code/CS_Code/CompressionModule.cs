...
public sealed class CompressionModule : IHttpModule
{
  ...
  private void context_BeginRequest(object sender, EventArgs e)
  {
      ...
      else
    {
        ...
        //string contentEncoding = app.Context.Request.Headers["Content-Encoding"];

        //if (string.Equals(contentEncoding, "gzip",
        //    StringComparison.OrdinalIgnoreCase))
        //{
        //    app.Context.Request.Filter = new GZipStream(app.Context.Request.Filter,
        //        CompressionMode.Decompress);
        //    app.Context.Request.Headers.Remove("Content-Encoding");
        //}
    }
  }
