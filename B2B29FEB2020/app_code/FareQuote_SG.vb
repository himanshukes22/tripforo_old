...
Public Class FareQuote_SG
    ...
    Function CheckFareResponse() As String
        Dim FareResponse As String = ""
        'Dim url As String = "http://directnettest.navitaire.com:8080/servlet/rpcrouter" 'test
        Dim url As String = System.Configuration.ConfigurationManager.AppSettings("SGURL") 'live
