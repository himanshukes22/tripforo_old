...
Partial Class SprReports_Admin_AdminHtlMarkup
    ...
    Protected Sub btn_Search_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Search.Click
        Try
            ...
            'Dim Star As String = ddlStar.SelectedValue
    ...
    Protected Sub btn_Submit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Submit.Click
        Try
            If Session("User_Type") = "ADMIN" Then
                ...
                Dim i As Integer = ST.InsHtlMarkup(Session("UID").ToString, AgentID, Country, City, "", MrkupType, Star, txtAmt.Text.Trim, "", "", "INSAdmin", 0)
                If i > 0 Then
                    Dim ds As New DataSet()
                    ds = Session("Grdds")
    ...
    Public Sub BindGridMarkup()
        Try
            'Dim ReqType As String = "", AgentID As String = "", HotelType As String = "", Star As String = ""
            'If Session("User_Type").ToString() = "ADMIN" Then
            '    ReqType = "AdminMrkSearch"
            '    AgentID = If([String].IsNullOrEmpty(Request("txtAgencyName")) Or Request("txtAgencyName") = "Agency Name or ID", "", Request("txtAgencyName"))
            'End If
            'If Session("User_Type").ToString() = "AGENT" Then
            '    ReqType = "AgentMrkSearch"
            'End If
            ...
            Dim Country As String = If([String].IsNullOrEmpty(Request("TR_Country")) Or Request("TR_Country") = "Country" Or Request("TR_Country") = "ALL", "ALL", Request("TR_Country"))
            Dim City As String = If([String].IsNullOrEmpty(Request("htlCity")) Or Request("htlCity") = "City" Or Request("City") = "ALL", "ALL", Request("htlCity"))
            Bindgrid(ST.GetHtlMarkup(Session("UID").ToString, AgentID, Country, City, Star, HotelType, Request("mrktype"), "", 0, "", "", "AdminMrkSearch"))
        Catch ex As Exception
            HotelDAL.HotelDA.InsertHotelErrorLog(ex, "")
        End Try
    End Sub
    Private Sub Bindgrid(ByVal ds As DataSet)
        Try
            ...
            Else
                ...
                NoRecard.InnerText = "No recard found"
            End If
        Catch ex As Exception
            HotelDAL.HotelDA.InsertHotelErrorLog(ex, "")
        End Try
