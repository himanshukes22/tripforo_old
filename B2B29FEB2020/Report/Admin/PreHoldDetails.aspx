<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageForDash.master" AutoEventWireup="false" CodeFile="PreHoldDetails.aspx.vb" Inherits="SprReports_Admin_PreHoldDetails" %>
   ...
   <%-- <link href="../../CSS/style.css" rel="stylesheet" type="text/css" />
    ...
    <div align="center">
        <table cellspacing="10" cellpadding="0" border="0" class="tbltbl" width="950px">
            <tr>
                <td align="center" class="" height="50px" style="font-size: 25px;">
                    Domestic Hold PNR Request
                </td>
            </tr>
            <tr>
                <td id="td_Reject" runat="server" align="right" visible="false" style="padding: 10px;
                    ...
                    <asp:Button ID="btn_Cancel" runat="server" Text="Cancel" CssClass="button"   Width="150px"/>
                </td>
            </tr>
            <tr>
                <td align="center">
                            ...
                            <asp:TemplateField HeaderText="Change Status">
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="LB_Reject" runat="server" CommandName="Reject" CommandArgument='<%#Eval("OrderId") %>'
                                        Font-Bold="True" Font-Underline="False" ForeColor="Red">Change to Hold</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
