<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAfterLogin.master" AutoEventWireup="true" CodeFile="ViewLog.aspx.cs" Inherits="SprReports_ViewLog" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

<link  href='../Styles/XMLDisplay.css'  type="text/css" rel="stylesheet"/>
    ...
    <script type="text/javascript">
        ...
        <asp:Panel ID="Panel1" runat="server">
            <div>
                <asp:DataList ID="DataList1" runat="server" BackColor="Gray" BorderColor="#666666" BorderStyle="None" BorderWidth="2px" CellPadding="3" CellSpacing="2"
                    ...
                    <ItemTemplate>
                        ...
                        <br />
                        <b>SSReqequest:</b>
                        <asp:Label ID="SSReqequest" runat="server" Text="SSReqequest" OnClick='<%#Eval("SSReq", "return GetXMLDetails(\"GetXML_Details\",\"SSReqequest\",\"{0}\")")%>' Style="cursor: pointer;"></asp:Label>
                        <br />
                        <b>SSResponse:</b>
                        ...
                        <br />
                        <b>PNRRTRequest:</b>
                        <asp:Label ID="PNRRTRequest" runat="server" Text="PNRRTRequest" OnClick='<%#Eval("PNRRTReq", "return GetXMLDetails(\"GetXML_Details\",\"{0}\")")%>' Style="cursor: pointer;"></asp:Label>
                        <br />
                        <b>PNRRTResponse:</b>
                        ...
                        <br />
                        <b>DOCPRDRequest:</b>
                        <asp:Label ID="DOCPRDRequest" runat="server" Text="DOCPRDRequest" OnClick='<%#Eval("DOCPRDReq", "return GetXMLDetails(\"GetXML_Details\",\"{0}\")")%>' Style="cursor: pointer;"></asp:Label>
                        <br />
                        <b>DOCPRDResponse:</b>
                        <asp:Label ID="DOCPRDResponse" runat="server" Text="SSResponse" OnClick='<%#DOCPRDResponse(Convert.ToString(Eval("DOCPRDRes")))%>' Style="cursor: pointer;"></asp:Label>
                        <br />
                        <b>PNRRT2Request:</b>
                        <asp:Label ID="PNRRT2Request" runat="server" Text="PNRRT2Request" OnClick='<%#Eval("PNRRT2Req", "return GetXMLDetails(\"GetXML_Details\",\"{0}\")")%>' Style="cursor: pointer;"></asp:Label>
                        <br />
                        <b>PNRRT2Response:</b>
                        <asp:Label ID="PNRRT2Response" runat="server" Text="PNRRT2Response" OnClick='<%#Eval("PNRRT2Res", "return GetXMLDetails(\"GetXML_Details\",\"{0}\")")%>' Style="cursor: pointer;"></asp:Label>
                        <br />
                        <b>SERequest:</b>
                        ...
                        <br />
                        <b>SEResponse:</b>
                        <asp:Label ID="SEResponse" runat="server" Text="SEResponse" OnClick='<%#GetXML("SEReq", Convert.ToString(Eval("SERes")))%>' Style="cursor: pointer;"></asp:Label>
                        <br />
                        <b>PNBFRequest1:</b>
            ...
            <div id="GetXML_Details" runat="server" style="text-align: left; width: 95%; height:85%; overflow-x:scroll; position: absolute; display: none; margin-top: 10px; background-color: #f9f9f9; font-size: 12px; font-weight: bold; padding: 20px; box-shadow: 0px 1px 5px #000; border: 5px solid #d1d1d1; border-radius: 10px; z-index: 1; top: 5%">
                <div class="close"></div>
                <div id="GL"></div>
            </div>
        </asp:Panel>
        <asp:Panel ID="Panel2" runat="server">
            ...
            <div id="JsonDiv" runat="server" style="text-align: center; position: absolute; display: none; margin-top: 1px; background-color: #f9f9f9; width: 95%; height:85%; font-size: 12px; font-weight: bold; padding: 20px;  overflow-x:scroll; box-shadow: 0px 1px 5px #000; border: 5px solid #d1d1d1; border-radius: 10px; z-index: 1; top: 5%">
            </div>
        </asp:Panel>
