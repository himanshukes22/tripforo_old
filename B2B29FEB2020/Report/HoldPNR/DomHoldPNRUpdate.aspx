<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageForDash.master" AutoEventWireup="false"
    CodeFile="DomHoldPNRUpdate.aspx.vb" Inherits="Reports_HoldPNR_DomHoldPNRUpdate" %>
        ...
        <table cellspacing="10" cellpadding="0" border="0" class="tbltbl"
            ...
            <tr>
                ...
                <td>
                    <table width="100%">
                        <tr>
                            <td align="center" class="Heading" height="50px" style="font-size: 30px;">Hold PNR Process
                            </td>
                        </tr>
                        <tr>
                            ...
                            <asp:Button ID="btn_Cancel" runat="server" Width="150px" Text="Cancel" CssClass="buttonfltbk" />
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
