<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageForDash.master" AutoEventWireup="false"
    CodeFile="IntlHoldPNRUpdate.aspx.vb" Inherits="Reports_HoldPNR_IntlHoldPNRUpdate" %>
        ...
        <table cellspacing="10" cellpadding="0" border="0"  class="tbltbl"
            ...
            <tr>
                ...
                <td>
                    <table width="100%">
                        <tr>
                            <td align="center" class="Heading" height="50px" style="font-size: 30px;">
                                Hold PNR Process
                            </td>
                        </tr>
                        <tr>
                            <td id="td_Reject" runat="server" align="right" visible="false" style="padding: 10px;
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <asp:GridView ID="GridHoldPNRAccept" runat="server" AllowPaging="True" AllowSorting="True"  AutoGenerateColumns="False"  CssClass="table table-hover" GridLines="None" Font-Size="12px">
                                    <Columns>
                                        <asp:TemplateField HeaderText="OrderId">
                                            <ItemTemplate>
                                                <%--<a id="ancher" href='PnrSummaryIntl.aspx?OrderId=<%#Eval("OrderId")%>'
