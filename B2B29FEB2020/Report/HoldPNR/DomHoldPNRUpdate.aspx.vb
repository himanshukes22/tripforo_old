...
Partial Class Reports_HoldPNR_DomHoldPNRUpdate
...
#End Region
    ...
    Public Sub BindGrid()
        Try
            ...
            RecordsDS = ID.IntlUpdateHoldPNR("InProcess", "D", Session("UID"))
    ...
    'Protected Sub GridHoldPNRAccept_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridHoldPNRAccept.RowDataBound
