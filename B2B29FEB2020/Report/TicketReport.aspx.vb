...
Partial Class SprReports_TicketReport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        'ticket_grdview.Columns("Reissue").Visible = False
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                End If
                grdds.Clear()
                grdds = ST.USP_GetTicketDetail_Intl(Session("UID").ToString, Session("User_Type").ToString, "", "", "", "", "", "", "", AgentID, trip.Trim(), StatusClass.Ticketed)
                'BindGrid(grdds)
                Dim dt As DataTable
                Dim Db As String = ""
                Dim sum As Double = 0
    ...
    Protected Sub ticket_grdview_RowDataBound(sender As Object, e As GridViewRowEventArgs)
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim VC As Label = TryCast(e.Row.FindControl("Airline"), Label)
            Dim Count As Label = TryCast(e.Row.FindControl("countFound"), Label)

            Dim link As LinkButton = TryCast(e.Row.FindControl("btnOnlineCanc"), LinkButton)
            link.Visible = False

            If (VC.Text = "G8" Or VC.Text = "6E" Or VC.Text = "SG") Then
