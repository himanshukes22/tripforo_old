    ...
    <form id="form1" runat="server">
     <nav class="navbar navbar-default navbar-inverse navbar-theme navbar-theme-abs navbar-theme-transparent navbar-theme-border" id="main-nav">
      ...
      <li class="user-menu__item">
        ...
        <div class="w3-card-2 topnav notranslate" id="topnav" style="position: fixed; top: 39px; z-index: 999; width: 65%; right: 0;border-radius: 65px 0px 0px 0px;">
        ...
        <div id="divtkt" runat="server" style="margin: 5px auto; width: 97%; background-color: #FFFFFF; padding: 5px;margin-top: 50px;">
            <div class="large-12 medium-12 small-12">
                 <div style="margin: 5px auto; width: 80%;padding:10px;">
                    ...
                    <%-- <ul class="nav navbar-nav">
                     ...
                     <ul class="nav navbar-nav" style="float: right !important;font-size:16px;">

                    <li class="user-menu__item"></li>
                    <li class="user-menu__item">
                        <a class="user-menu-link" href='javascript:;' onclick="myPrint()">
        ...
        <div class="modal fade" id="markup" role="dialog">
            <div class="modal-dialog">
