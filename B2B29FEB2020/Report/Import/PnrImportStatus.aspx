<%@ Page Title="" Language="VB" MasterPageFile="~/MasterAfterLogin.master" AutoEventWireup="false"
    CodeFile="PnrImportStatus.aspx.vb" Inherits="Reports_Import_PnrImportStatus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="boxshadow w70 auto">
        <tr>
            <td align="left" style="color: #fff; font-weight: bold; padding-top: 7px;" colspan="6">Search Domestic Import Booking
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="right" colspan="6">
                ...
                <asp:Button ID="btn_result" runat="server" Text="Search Result" CssClass="buttonfltbks" /></td>
        </tr>
