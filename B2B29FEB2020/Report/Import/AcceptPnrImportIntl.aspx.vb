...
Imports System.Data
Partial Class Reports_Import_AcceptPnrImportIntl
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        End If
        Try
            BindDate(ST.ImportPNRDetailsIntl("Pending", "I"))
    ...
    Protected Sub ITZ_Accept_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Try
            ...
            dtstatus = ST.PnrImportIntlDetails(orderid, "I").Tables(0)
    ...
    Protected Sub ITZ_Reject_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            Else
                ClientScript.RegisterStartupScript(Page.GetType(), "Alert", "alert('Already Rejected');", True)
            End If
