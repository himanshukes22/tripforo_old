<%@ Page Title="" Language="VB" MasterPageFile="~/MasterAfterLogin.master" AutoEventWireup="false"
    CodeFile="UpdateImportPnr.aspx.vb" Inherits="Reports_Import_UpdateImportPnr" %>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td height="25px" width="130px" class="text1">
                                            Agency ID :
                                            <asp:Label ID="lbl_mn" runat="server" Visible="False"></asp:Label>
                                        </td>
                                        <td id="td_AgencyID" runat="server" width="130px" class="Text">
                                        </td>
                                        <td width="100px" class="text1" align="left">
                                            Credit Limit :
                                        </td>
                                    ...
                                    <tr>
                                        <td height="25px" class="text1" align="left">
                                            Agency Type :
                                        </td>
                                        ...
                                        <td width="50%" valign="top">
                                            <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                ...
                                                <tr id="tr_corp" runat="server">
                                                    ...
                                                    <td id="td_ProjectId" runat="server">
                                                    </td>
                                                    <td align="left">
                                                        Booked By:
                                                    </td>
                                                    <td id="td_BookedBy" runat="server">
                                                    </td>
                                                </tr>
                                ...
                                <table cellpadding="2" cellspacing="2" border="0" width="100%">
                                    <tr>
                                        ...
                                        <td height="30px" width="14%">
                                            <asp:Label ID="lblTtlFare" runat="server"></asp:Label>
                                        </td>
                                        <td width="15%" height="30px" align="left" style="font-weight: bold; padding-left: 5px;">
                                            Service Tax : &nbsp;
                                        </td>
                                        <td width="20%" height="30px">
                                            <asp:Label ID="lblSrvTax" runat="server"></asp:Label>
                                        </td>
                                        <td width="15%" height="30px" align="left" style="font-weight: bold; padding-left: 5px;">
                                            Tran. Fee : &nbsp;
                                        </td>
                                        <td width="20%" height="30px">
                                            <asp:Label ID="lblTF" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td height="30px">
                                            <asp:Label ID="lbltfAftrDis" runat="server" Font-Bold="False"></asp:Label>
                                        </td>
                                        <td height="30px" align="left" style="font-weight: bold; padding-left: 5px;">
                                            Dis. + Cash Back : &nbsp;
                                        </td>
                                        <td height="30px">
                                            <asp:Label ID="lblTtlDis" runat="server"></asp:Label>
                                            +
                                            <asp:Label ID="lblTtlCB" runat="server"></asp:Label>
                                        </td>
                                        <td height="30px" align="left" style="font-weight: bold; padding-left: 5px;">
                                            TDS : &nbsp;
                                        </td>
