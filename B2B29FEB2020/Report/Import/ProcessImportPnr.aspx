<%@ Page Title="" Language="VB" MasterPageFile="~/MasterAfterLogin.master" AutoEventWireup="false"
    CodeFile="ProcessImportPnr.aspx.vb" Inherits="Reports_Import_ProcessImportPnr" %>
    ...
    <table cellspacing="5" cellpadding="0" border="0"  class="tbltbl" width="950px">
                    ...
                    <tr>
                        ...
                        <td>
                            <table width="100%">
                                <tr>
                                    <td align="center" height="50px" class="Heading" style="font-size: 25px; color: #004b91;
                                        font-family: arial, Helvetica, sans-serif; font-weight: bold;">
                                        Domestic PNR Import processing detail
                                    </td>
                                </tr>
                                <tr>
                                    <td id="td_RejectRmk" runat="server" align="right" visible="false" colspan="2" style="padding: 10px;
                                        ...
                                        <br />
                                        <asp:Button ID="Button1" runat="server" Text="Submit Remark" />
                                ...
                                <tr>
                                    <td id="td_AgentRmk" runat="server" align="right" visible="false" colspan="2" style="padding: 10px;
                                        border: thin solid #999999;">
                                                ...
                                                <asp:TemplateField HeaderText="">
                                                    <ItemTemplate>
                                                        <a id="ancher" runat="server" rel="lyteframe" rev="width: 800px; height: 300px; overflow:hidden;"
                                                            style="font-family: arial, Helvetica, sans-serif; font-size: 12px; color: #800000;
                                                            font-weight: bold;"></a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="">
                                                    <ItemTemplate>
                                                        <a id="ancherupdate" runat="server" style="font-family: arial, Helvetica, sans-serif;
                                                            font-size: 12px; color: #800000; font-weight: bold;"></a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
