...
Partial Class Reports_Import_ProcessImportPnrIntl
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            BindDate(ST.ImportPNRDetailsIntl("Processed", "I", "", Session("UID").ToString))
    ...
    Sub BindDate(ByVal ImportPnrDs As DataSet)
        Try
            ...
            For Each rowitem As GridViewRow In GridImportProxyDetail.Rows
                ...
                DirectCast(rowitem.FindControl("ancherupdate"), HtmlAnchor).HRef = "UpdateImportPnrIntl.aspx?OrderId=" & (pnrArray(0)("OrderId")).ToString
