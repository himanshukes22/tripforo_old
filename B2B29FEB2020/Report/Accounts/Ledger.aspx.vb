...
Partial Class Reports_Accounts_Ledger
    ...
    Public Sub CheckEmptyValue()
        Try
            ...
            dtsaerch = STDom.GetLedgerDetails(Session("User_Type"), Session("UID").ToString, FromDate, ToDate, AgentID, BookingType, SearchType, Amount, OrderNo, AirCode).Tables(0)
            Dim dtClosBal As New DataTable
            dtClosBal = STDom.GetLedgerDetails(Session("User_Type"), Session("UID").ToString, FromDate, ToDate, AgentID, BookingType, "CLOSINGBAL", Amount, OrderNo, AirCode).Tables(0)
    ...
    Public Sub ExportEmptyValue()
        Try
            ...
            dtsaerch = STDom.GetLedgerDetails(Session("User_Type"), Session("UID").ToString, FromDate, ToDate, AgentID, BookingType, SearchType, Amount, OrderNo, AirCode)
