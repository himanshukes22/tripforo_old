<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BusInvoiceDetails.aspx.vb"
    Inherits="SprReports_Accounts_BusInvoiceDetails" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<title>Bus Invoice Details</title>
<head>
    ...
    <script type="text/javascript" language='javascript'>
        function callprint(strid) {
            ...
            WinPrint.document.write("<html><title></title><body onload='window.print()'>" + divprint.innerHTML + "</body></html>");
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="900px">
            ...
            <tr>
                <td align="center">
                    ...
                    <asp:Button ID="btn_Word" runat="server" CssClass="buttonfltbk" Text="Export To Word" CausesValidation="False"
                        OnClick="btn_Word_Click" />
                    <asp:Button ID="btn_Excel" runat="server" CssClass="buttonfltbk" Text="Export To Excel" CausesValidation="False"
        ...
        <table width="50%" border="0" cellspacing="2" cellpadding="2" bgcolor="#20313f" align="center">
            ...
            <tr>
                ...
                <td width="30%" valign="top" align="left">
                    <asp:Button ID="btn" runat="server" CssClass="buttonfltbks" Text="Send"></asp:Button>
                </td>
            </tr>
            <tr>
