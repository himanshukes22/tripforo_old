...
Imports System.IO
Partial Class CreditNodeDomDetailsMass
    ...
    Public Sub CreditNodeDetail()
        Try
            ...
            dt = STDom.GetCreditNodeDetailsMass(Request("PNRNO"), "D", "Cancelled").Tables(0)
            ...
            If (dt.Rows.Count > 0) Then
                ...
                If Not IsDBNull(dt.Rows(0)("BillNoAir")) Then
                    ...
                    BillNoAir = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=""text-align:right;"" >&nbsp; </span>"
                End If
                ...
                my_table += "<td  style='flot:left; height:30px;padding: 4px 2px; color: #424242; background-color: #eee; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #BBF1FF;'>&nbsp;&nbsp;  CREDIT NOTE NO :  " & Convert.ToString(dt.Rows(0)("RefundID")) & "</td>"
                my_table += "<td  style='height:30px;padding: 4px 2px; color: #424242; background-color: #eee; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #BBF1FF;'>&nbsp;&nbsp;  DATE :  " & Convert.ToString(dt.Rows(0)("UpdateDate")) & "</td>"
                my_table += "</tr>"
                my_table += "<tr>"
                my_table += "<td style='float:right;height:30px;font-size: 18px;font-weight: bold; font-family: arial, Helvetica, sans-serif;'>  &nbsp;&nbsp;ADDRESS :<img alt='' src='Images/arrow.jpg'  /> </td>"
                my_table += "</tr>"
                ...
                my_table += "<td style='padding: 4px 2px; color: #424242; background-color: #eee; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #eee;' align='center'>Flight</td>"
                ...
                my_table += "<td style='padding: 4px 2px; color: #424242; background-color: #eee; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #eee;' align='center'>Trip Type</td>"
                ...
                If MgtFeeVisibleStatus = True Then
                    Total = Convert.ToDouble(dt.Rows(0)("Base_FareS").ToString()) + Convert.ToDouble(dt.Rows(0)("TaxS").ToString()) '+ Convert.ToDouble(dt.Rows(0)("Service_Tax").ToString()) + Convert.ToDouble(dt.Rows(0)("Tran_Fees").ToString())
                Else
                    Total = Convert.ToDouble(dt.Rows(0)("Base_FareS").ToString()) + Convert.ToDouble(dt.Rows(0)("TaxS").ToString()) + Convert.ToDouble(dt.Rows(0)("Service_TaxS").ToString()) + Convert.ToDouble(dt.Rows(0)("Tran_Fees").ToString())
                End If
                ...
                my_table += "<td style=' font-family: arial, Helvetica, sans-serif;font-size: 13px; line-height: 25px;color: #000000;' align='center'>" & dt.Rows(0)("FlightNo").ToString() & "</td>"
                ...
                my_table += "<td style=' font-family: arial, Helvetica, sans-serif;font-size: 13px; line-height: 25px;color: #000000;' align='center'>" & dt.Rows(0)("trip1").ToString() & "</td>"
                ...
                my_table += "<td style=' font-family: arial, Helvetica, sans-serif;font-size: 13px; line-height: 25px;color: #000000;' align='center'>" & dt.Rows(0)("Base_FareS").ToString() & "</td>"
                my_table += "<td style=' font-family: arial, Helvetica, sans-serif;font-size: 13px; line-height: 25px;color: #000000;' align='center'>" & dt.Rows(0)("TaxS").ToString() & "</td>"

                If (IsCorp = False) Then
                    my_table += "<td style=' font-family: arial, Helvetica, sans-serif;font-size: 13px; line-height: 25px;color: #000000;' align='center'>" & dt.Rows(0)("Service_TaxS").ToString() & "</td>"
                ...
                If dt.Rows(0)("ServiceCharge").ToString <> "" AndAlso dt.Rows(0)("ServiceChargeS").ToString IsNot Nothing Then
                    servicecharge = Convert.ToDouble(dt.Rows(0)("ServiceChargeS").ToString)
                Else
                    servicecharge = 0
                End If
                If (IsCorp = True) Then
                    ...
                    my_table += "<td  style='font-family: arial, Helvetica, sans-serif;font-size: 13px; line-height: 25px;color: #000000;' align='center'>" & dt.Rows(0)("Service_TaxS").ToString() & "</td>"
                    my_table += "</tr>"
                    NetFare = (Total + Convert.ToDouble(mgtFee) + Convert.ToDouble(dt.Rows(0)("Service_TaxS").ToString()))
                    ...
                    cancellationcharge = Convert.ToDouble(dt.Rows(0)("Service_TaxS").ToString()) + mgtFee + Convert.ToDouble(dt.Rows(0)("CancellationChargeS")) + servicecharge
                ...
                Else
                    ...
                    my_table += "</tr>"
                    my_table += "<td colspan='9' style=' font-family: arial, Helvetica, sans-serif;font-size: 11px; line-height: 25px;color: #000000;' align='left'><b>Passenger: <b>" & dt.Rows(0)("PaxDetails").ToString() & "</td>"
                    my_table += "<td colspan='1' style=' font-family: arial, Helvetica, sans-serif;font-size: 11px; line-height: 25px;color: #000000;' align='right'>DISCOUNT(-)&nbsp;&nbsp;</td>"
                    my_table += "<td  style=' font-family: arial, Helvetica, sans-serif;font-size: 13px; line-height: 25px;color: #000000;' align='center'>" & Convert.ToDouble(dt.Rows(0)("DiscountS").ToString()) - Convert.ToDouble(dt.Rows(0)("Tran_Fees").ToString()) & "</td>"
                    my_table += "</tr>"

                    my_table += "</tr>"
                    my_table += "<td colspan='9' style=' font-family: arial, Helvetica, sans-serif;font-size: 11px; line-height: 25px;color: #000000;' align='left'><b>TicketNumber: <b>" & dt.Rows(0)("TicketNumber").ToString() & "</td>"
                    my_table += "<td colspan='1' style=' font-family: arial, Helvetica, sans-serif;font-size: 11px; line-height: 25px;color: #000000;' align='right'>TDS(+)&nbsp;&nbsp;</td>"
                    my_table += "<td  style=' font-family: arial, Helvetica, sans-serif;font-size: 13px; line-height: 25px;color: #000000;' align='center'>" & dt.Rows(0)("TDSS").ToString() & "</td>"
                    my_table += "</tr>"
                    NetFare = (Total + Convert.ToDouble(dt.Rows(0)("TDSS").ToString())) - Convert.ToDouble(dt.Rows(0)("DiscountS").ToString())
                    my_table += "<tr  style=' padding: 4px 2px;color: #000000; background-color: #FFFF66; font-size: 13px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #eee; line-height: 20px;'>"
                    ...
                    my_table += "<td  style=' font-family: arial, Helvetica, sans-serif;font-size: 13px; line-height: 25px;color: #000000;' align='center'>" & dt.Rows(0)("CancellationChargeS").ToString() & "</td>"
                    my_table += "</tr>"
                ...
                If IsCorp = True Then
                    RefAmt = NetFare - (Convert.ToDouble(dt.Rows(0)("CancellationChargeS").ToString()) + servicecharge + mgtFee + Convert.ToDouble(dt.Rows(0)("Service_TaxS").ToString()))
                Else
                    RefAmt = NetFare - (Convert.ToDouble(dt.Rows(0)("CancellationChargeS").ToString()) + servicecharge)
                End If
                ...
                my_table += "<td  style=' font-family: arial, Helvetica, sans-serif;font-size: 13px; line-height: 25px;color: #000000;' align='center'>" & dt.Rows(0)("TDSS").ToString() & "</td>"
                my_table += "</tr>"
                RefAmt = RefAmt - Convert.ToDouble(dt.Rows(0)("TDSS").ToString())
                ' End If
            ...
            Else
                ...
                my_table += "<table width='100%' border='0' cellspacing='0'  cellpadding='0' align='center'>"
                my_table += "<tr>"
                my_table += "<td align='center'>Credit Note is Not Genereted For This Ticket </td>"
                my_table += "</tr>"
                my_table += "</table>"
