<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageForDash.master" AutoEventWireup="false"
    CodeFile="AccountPanel.aspx.vb" Inherits="Reports_Accounts_AccountPanel" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Agency ID">
                                            <ItemTemplate>
                                                ...
                                                <div>
                                                    <a target="_self" href="UploadCredit.aspx?AgentID=<%#Eval("AgencyID")%> &ID=<%#Eval("Counter")%>#lightbox"></a>
                                                </div>
