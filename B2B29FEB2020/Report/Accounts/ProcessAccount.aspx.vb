...
Imports System.Data
Partial Class Reports_Accounts_ProcessAccount
            ...
            If Not IsPostBack Then
                Try
                    If Session("UID") <> "" AndAlso Session("UID") IsNot Nothing Then
                        grd_accdeposit.DataSource = STDom.DepositStatusDetails("InProcess", Session("UID"))
    ...
    Private Sub BindGrid()
        Try
            ...
            dtgrid = STDom.DepositProcessDetails("InProcess", ddl_Category.SelectedValue).Tables(0)
    ...
    Private Sub SearchText()
        Try
            If ddl_Category.SelectedValue = "--Select Category--" Then
                Dim dt As DataTable = STDom.DepositStatusDetails("InProcess", Session("UID")).Tables(0)
