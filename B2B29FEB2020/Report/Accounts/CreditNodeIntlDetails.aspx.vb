...
Imports System.IO
Partial Class Reports_Accounts_CreditNodeIntlDetails
    ...
    Public Sub CreditNodeDetail()
        Try
            ...
            dt = STDom.GetCreditNodeDetails(Request("RefundID"), "I", "Cancelled").Tables(0)
            ...
            my_table += "<tr>"
            my_table += "<td  style='height:30px;padding: 4px 2px; color: #fff; background-color: gray; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #BBF1FF;'>&nbsp;&nbsp;  CREDIT NOTE NO :  " & If(BillNoCorp = "", Request("RefundID"), BillNoCorp) & "" & BillNoAir & projectIdShow & cancelledBy & "</td>"
            my_table += "</tr>"
            my_table += "<tr>"
            ...
            my_table += "<tr>"
            my_table += "<td style='padding: 4px 2px; color: #fff; background-color: #004b91; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #004b91;' align='center'>PNR</td>"
            my_table += "<td style='padding: 4px 2px; color: #fff; background-color: #004b91; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #004b91;' align='center'>Ticket</td>"
            my_table += "<td style='padding: 4px 2px; color: #fff; background-color: #004b91; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #004b91;' align='center'>Airline</td>"
            my_table += "<td style='padding: 4px 2px; color: #fff; background-color: #004b91; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #004b91;' align='center'>Passenger</td>"

            my_table += "<td style='padding: 4px 2px; color: #fff; background-color: #004b91; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #004b91;' align='center'>Sector</td>"
            my_table += "<td style='padding: 4px 2px; color: #fff; background-color: #004b91; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #004b91;' align='center'>DDate</td>"

            my_table += "<td style='padding: 4px 2px; color: #fff; background-color: #004b91; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #004b91;' align='center'>BaseFare</td>"
            my_table += "<td style='padding: 4px 2px; color: #fff; background-color: #004b91; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #004b91;' align='center'>Tax</td>"
            If (IsCorp = False) Then

                my_table += "<td style='padding: 4px 2px; color: #fff; background-color: #004b91; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #004b91;' align='center'>Srv Tax</td>"
                my_table += "<td style='padding: 4px 2px; color: #fff; background-color: #004b91; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #004b91;' align='center'>TF</td>"
            End If

            my_table += "<td style='padding: 4px 2px; color: #fff; background-color: #004b91; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #004b91;' align='center'>Total</td>"
            ' my_table += "<td style='padding: 4px 2px; color: #fff; background-color: #004b91; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #004b91;' align='center'>Fare</td>"
            ...
            'End If '+ Convert.ToDouble(dt.Rows(0)("Service_Tax").ToString()) 



            'Dim RefAmt = NetFare - (Convert.ToDouble(dt.Rows(0)("CancellationCharge").ToString()) + servicecharge)
            'Dim RefAmt = NetFare - (Convert.ToDouble(dt.Rows(0)("CancellationCharge").ToString()) + servicecharge + mgtFee + Convert.ToDouble(dt.Rows(0)("Service_Tax").ToString()))
            ...
            my_table += "<tr style='padding: 4px 2px; color: #fff; background-color: #004b91; font-size: 12px;font-weight: bold; font-family: arial, Helvetica, sans-serif; border-left-color: #004b91;'>"
