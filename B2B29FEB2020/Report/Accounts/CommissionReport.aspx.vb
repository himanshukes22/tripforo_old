...
Partial Class SprReports_Accounts_CommissionReport
    ...
    Public Sub CheckEmptyValue()
        Try
            ...
            grdds = ST.IntGetInvoice(Session("UID").ToString, Session("User_Type").ToString, FromDate, ToDate, OrderID, PNR, TicketNo, AgentID, ddl_SelectDDL.SelectedValue, Airline, ProjectId)
            ...
            Dim total As Decimal = Convert.ToDecimal(grdds.Tables(0).Compute("SUM(TotalDiscount)", String.Empty))
            ''Dim total As Decimal = grdds.Tables(0).AsEnumerable().Sum(Function(row) row.Field(Of Decimal)("Price"))
            totalsum.Text = "Total Commission: " + total.ToString("N2")

            'grd_IntsaleRegis.FooterRow.Cells(8).Text =
            'grd_IntsaleRegis.FooterRow.Cells(8).HorizontalAlign = HorizontalAlign.Right
            'grd_IntsaleRegis.FooterRow.Cells(9).Text = total.ToString("N2")
    ...
    Public Sub ExportResult()
        Try
            ...
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("ServiceTax"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("Discount"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("CashBack"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("EasyID"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("EasyTransNo"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("AgentType"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("AdminMrk"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("AgentMrk"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("ORIGINALDISCOUNT"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("ORIGINALSRVTAX"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("MealPrice"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("BaggagePrice"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("PartnerName"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("PaymentMode"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("PgCharges"))

            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("ResuId"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("AgentID"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("AgencyName"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("basefare"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("YQ"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("TotalTax"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("TranFee"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("MgtFee"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("totalfare"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("totalafterdis"))
            grdds.Tables(0).Columns.Remove(grdds.Tables(0).Columns("Tds"))
            ...
            STDom.ExportData(grdds, "CommissionReport " & ddl_SelectDDL.SelectedItem.Text & "Sum" & totalsum.Text.ToString & FromDate & "-To-" & ToDate)
