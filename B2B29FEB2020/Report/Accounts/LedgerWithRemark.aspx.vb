...
Partial Class Report_Accounts_LedgerWithRemark
    ...
    Public Sub CheckEmptyValue()
        Try
            ...
            dtsaerch = STDom.LedgerWithDetailSingleOrderID(Session("User_Type"), Session("UID").ToString, FromDate, ToDate, AgentID, BookingType, SearchType).Tables(0)
            Dim dtClosBal As New DataTable
            dtClosBal = STDom.LedgerWithDetailSingleOrderID(Session("User_Type"), Session("UID").ToString, FromDate, ToDate, AgentID, BookingType, "CLOSINGBAL").Tables(0)
    ...
    Public Sub ExportEmptyValue()
        Try
            ...
            dtsaerch = STDom.LedgerWithDetailSingleOrderID(Session("User_Type"), Session("UID").ToString, FromDate, ToDate, AgentID, BookingType, SearchType)
