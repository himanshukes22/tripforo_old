<%@ Page Language="VB" MasterPageFile="~/MasterPageForDash.master" AutoEventWireup="false" CodeFile="ADJProcessAccount.aspx.vb" Inherits="SprReports_Accounts_ADJProcessAccount" Title="Untitled Page" %>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td align="center" class="Heading" colspan="3"
                                            style="font-size: 20px; padding-bottom: 10px; background-color: #EAEAEA; padding-top: 10px;">Adjustment Inprocess Details
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Agency ID">
                                            <ItemTemplate>
                                                <%--     <div id="sk-lightbox-wrapper">
                                                                    ...
                                                                    </div>--%><asp:Label ID="lbl_uid" runat="server" Text='<%#Eval("AgencyID")%>' Font-Bold="True"
                                        ...
                                        <asp:TemplateField HeaderText="Reject">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="lnkaccept" runat="server" Text="Accept" CommandName="accept"
                                                    CommandArgument='<%#Eval("Counter") %>' ForeColor="#004b91" Font-Bold="True">Confirm</asp:LinkButton>
                                                </br>
                                                ||</br>
