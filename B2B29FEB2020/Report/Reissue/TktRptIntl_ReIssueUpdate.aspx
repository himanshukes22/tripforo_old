<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TktRptIntl_ReIssueUpdate.aspx.vb"
    Inherits="SprReports_Reissue_TktRptIntl_ReIssueUpdate" %>
...
<body>
    ...
    <div class="divUpdate">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #fff;">
            <tr>
                <td align="center">
                    <table border="0" cellpadding="0" cellspacing="0" width="99%">
                        <tr>
                            <td align="center" height="40px" style="font-size: 24px; color: #004b91; font-weight: bold;" colspan="6">
                                Update ReIssue
                            </td>
                        </tr>
                        <%--<tr>
                            <td class="Proxy" colspan="6">
                                Agency Detail
                            </td>
                        </tr>--%>
                        <tr>
                            <td class="TextBig" width="65px" height="20px" align="left">
                                Agent ID:
                            </td>
                            <td id="td_AgentID" runat="server"  >
                            </td>
                             <td class="TextBig" width="92px" align="left">
                                Agency Name:
                            </td>
                            <td  id="td_AgencyName" runat="server" >
                            </td>
                            <td class="TextBig" width="83px" height="20px" align="left">
                                Credit Limit:
                            </td>
                            <td id="td_CardLimit" runat="server"  width="380px">
                            </td>
                        </tr>
                        <tr>
                            <td class="TextBig" width="65px" align="left">
                                Mobile No:
                            </td>
                            <td id="td_AgentMobNo" runat="server" >
                            </td>
                             <td class="TextBig" width="83px" height="20px" align="left">
                                Email:
                            </td>
                            ...
                            <td class="TextBig" align="left" width="83px">
                                Address:
                            </td>
                            <td id="td_AgentAddress" runat="server"  width="380px">
                            </td>
            ...
            <tr><td></td></tr>
            <tr><td height="40px" style="font-size: 24px; color: #004b91; font-weight: bold;">Flight Details</td></tr>
            
             <tr>
                <td>
          
                     <asp:GridView ID="Flightgrid" runat="server" AutoGenerateColumns="False" CssClass="mGrid">
                        <Columns>
                            <asp:TemplateField HeaderText="Sector">
                                <ItemTemplate>
                                <asp:Label ID="Sectors1" runat="server" Text='<%#Eval("DEPCITYORAIRPORTCODE") %>'></asp:Label> : 
                                 <asp:Label ID="Sectors2" runat="server"  Text='<%#Eval("ARRCITYORAIRPORTCODE") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Departure Date">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtDEPDATEs" runat="server" Text='<%# Bind("DEPDATE") %>' onKeyPress="return checkit(event)" Width="83px"  MaxLength="6"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="DEPDATEs" runat="server" Text='<%#Eval("DEPDATE") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="Departure Time">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtDEPTIMEs" runat="server" Text='<%# Bind("DEPTIME") %>' onKeyPress="return checkit(event)" Width="83px"  MaxLength="6"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="DEPTIMEs" runat="server" Text='<%#Eval("DEPTIME") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="Arrival Date">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtARRDATEs" runat="server" Text='<%# Bind("ARRDATE") %>' onKeyPress="return checkit(event)" Width="83px"  MaxLength="6"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="ARRDATEs" runat="server" Text='<%#Eval("ARRDATE") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="Arrival Time">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtARRTIMEs" runat="server" Text='<%# Bind("ARRTIME") %>' onKeyPress="return checkit(event)" Width="83px"  MaxLength="6"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="ARRTIMEs" runat="server" Text='<%#Eval("ARRTIME") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="Flight No">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtFLTNUMBERs" runat="server" Text='<%# Bind("FLTNUMBER") %>' onKeyPress="return checkit(event)" Width="83px"  MaxLength="6"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="FLTNUMBERs" runat="server" Text='<%#Eval("FLTNUMBER") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                           ...
                           <asp:TemplateField HeaderText="EDIT">
                                ...
                                <EditItemTemplate>
                                    <asp:ImageButton ID="lbkUpdate" runat="server" CausesValidation="True" 
                                    ...
                                    <asp:ImageButton ID="lnkCancel" runat="server" CausesValidation="False" 
                                        CommandName="Cancel" Text="CANCEL" ToolTip="Cancel" Height="16px" Width="20px"
                                         ForeColor="#20313f" Font-Strikeout="False" Font-Overline="False" 
                                        Font-Bold="true" ImageUrl="../../Images/cancel.jpg"  ></asp:ImageButton>
                                </EditItemTemplate>
                            </asp:TemplateField> 
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblCounter" runat="server" Text='<%#Eval("FltId")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                         </Columns>
                     </asp:GridView>
            ...
            <tr>
                <td>
                  <table width="100%" cellpadding="2" cellspacing="2">
                   ...
                   <tr>
                        <td colspan="6" class="TextBig" >
                            <table cellpadding="11" cellspacing="11">
                                <tr >
                                    <td>
                                        Gds Pnr :
                                    </td>
                    ...
                    <tr>
                     <td colspan="6">
                         <table id="PNRandTkt" cellpadding="11" cellspacing="11">
                                                    <tr>
                            <td style="width: 65px;" class="TextBig">Remark:</td>
                            <td> 
                            ...
                            <td colspan="4" align="center">
                                         ...
                                         <div id="div_Submit"> 
                                          <asp:Button ID="btn_Update" runat="server" Text="Update"  CssClass="button" OnClientClick ="return Reissue(this);"/>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                         
                   ...
                   <%-- <tr id="SectorTR1" runat="server" visible="false" class="TextBig">
                        <td id="Sector1" runat="server" style="border: 1px dotted Black;">
                        </td>
                        <td colspan="5">
                    ...
                    <tr style="padding-left: 4px; height: 29px;">
                        <td>
                            <input id="txt_date" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtDepTime" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtArivalDate" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtArivalTime" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtFltNo" type="text" runat="server" readonly="readonly" style="border: none; width: 83px;" />
                        </td>
                        <td width="20px">
                            <img src="../../Images/edit.png" onclick="return PopupDiv('Flight1')" />
                        </td>
                    </tr>
                    <tr id="SectorTR2" runat="server" visible="false" class="TextBig">
                        <td id="Sector2" runat="server" style="border: 1px dotted Black;">
                        </td>
                        <td colspan="5">
                            <hr style="border: 1px dotted Black;" />
                        </td>
                    </tr>
                    <tr id="TRSecondFlt" runat="server" visible="false" class="TextBig">
                        <td>
                            Departure Date
                        </td>
                        <td>
                    ...
                    <tr id="TRSecondFlt2" runat="server" visible="false" style="padding-left: 4px; height: 29px;">
                        <td>
                            <input id="txt_date2" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtDepTime2" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtArivalDate2" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtArivalTime2" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtFltNo2" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td width="20px">
                     ...
                     <tr id="SectorTr3" runat="server" visible="false" class="TextBig">
                        <td id="Sector3" runat="server" style="border: 1px dotted Black;">
                        </td>
                        <td colspan="5">
                            <hr style="border: 1px dotted Black;" />
                        </td>
                    </tr>
                    <tr id="TRThirdFlt" runat="server" visible="false" class="TextBig">
                        <td>
                            Departure Date
                        </td>
                        <td>
                    ...
                    <tr id="TRThirdFlt2" runat="server" visible="false" style="padding-left: 4px; height: 29px;">
                        <td>
                            <input id="txt_date3" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtDepTime3" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtArivalDate3" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtArivalTime3" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtFltNo3" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td width="20px">
                     ...
                     <tr id="SectorTr4" runat="server" visible="false" class="TextBig">
                        <td id="Sector4" runat="server" style="border: 1px dotted Black;">
                        </td>
                        <td colspan="5">
                            <hr style="border: 1px dotted Black;" />
                        </td>
                    </tr>
                    <tr id="TRFourthFlt" runat="server" visible="false" class="TextBig">
                        <td>
                            Departure Date
                        </td>
                        <td>
                    ...
                    <tr id="TRFourthFlt2" runat="server" visible="false" style="padding-left: 4px; height: 29px;">
                        <td>
                            <input id="txt_date4" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtDepTime4" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtArivalDate4" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtArivalTime4" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtFltNo4" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td width="20px">
                    ...
                    <tr id="SectorTr5" runat="server" visible="false" class="TextBig">
                        <td id="Sector5" runat="server" style="border: 1px dotted Black;">
                        </td>
                        <td colspan="5">
                            <hr style="border: 1px dotted Black;" />
                        </td>
                    </tr>
                    <tr id="TRFifthFlt" runat="server" visible="false" class="TextBig">
                        <td>
                            Departure Date
                        </td>
                        <td>
                    ...
                    <tr id="TRFifthFlt2" runat="server" visible="false" style="padding-left: 4px; height: 29px;">
                        <td>
                            <input id="txt_date5" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtDepTime5" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtArivalDate5" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtArivalTime5" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtFltNo5" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td width="20px">
                    ...
                    <tr id="SectorTr6" runat="server" visible="false" class="TextBig">
                        <td id="Sector6" runat="server" style="border: 1px dotted Black;">
                        </td>
                        <td colspan="5">
                            <hr style="border: 1px dotted Black;" />
                        </td>
                    </tr>
                    <tr id="TRSixthFlt" runat="server" visible="false" class="TextBig">
                        <td>
                            Departure Date
                        </td>
                        <td>
                    ...
                    <tr id="TRSixthFlt2" runat="server" visible="false" style="padding-left: 4px; height: 29px;">
                        <td>
                            <input id="txt_date6" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtDepTime6" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtArivalDate6" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtArivalTime6" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td>
                            <input id="txtFltNo6" type="text" runat="server" readonly="readonly" style="border: none;
                                width: 83px;" />
                        </td>
                        <td width="20px">
                            ...
                            <table cellpadding="11" cellspacing="11">
                                <tr >
                                    <td>
                                     ...
                                     <td>
                                        <input id="txt_pnr" type="text"  runat="server" style="width: 130px;" />
                                    </td>
                                    <td ></td>
                                    <td>
                                       Airline Pnr :
                                     ...
                                     <td>
                                        <input id="txtAirPnr" type="text"  runat="server" style="width: 130px;" />
                                    </td>
                                    <td></td>
                                    <td>
                                       Ticket Number :
                                     ...
                                     <td >
                                        <input id="txtTktNo"  name="txtAirPnr" runat="server" style=" width: 130px;"/>
                                    </td>
                                </tr>
                                <tr>
                                <td>
                                     ...
                                     <td>
                                        <input id="txt_Reissue_charge" name="txt_Reissue_charge" type="text" style="width: 130px;" onkeypress="return NumericOnly(event)" />
                                    </td>
                                    <td></td>
                                    <td>
                                       Service Charge :
                                    ...
                                    <td>
                                        <input id="txt_farediff" name="txt_farediff" type="text" style="width: 130px;" onkeypress="return NumericOnly(event)" />
                                    </td>
                                </tr>
                            </table>
                       </td>
                     ...
                     <td colspan="6">
                         <table id="PNRandTkt" cellpadding="11" cellspacing="11">
                            ...
                            <td colspan="4" align="center">
                                         ...
                                         <div id="div_Submit"> 
                                          <asp:Button ID="btn_Update" runat="server" Text="Update" OnClientClick="return Validate();" CssClass="button" />
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                         
                                            <asp:Button ID="btnClose" runat="server" Text="Close" CssClass="button" />
                                            </div>
                                        </td>
                ...
                <td>
                    <div id="MapPopup_box">
                        <div id="Mapmnfvc">
                            <div class="Mapmnfvc1">
                                <div class="Mapmnfvc2">
                                    <table border="0" cellpadding="0" cellspacing="0" style="width: 650px; margin: auto;
                                        background: #fff; -webkit-border-radius: 10px; -o-border-radius: 10px; -moz-border-radius: 10px;
                                        border: 4px solid #888; padding: 11px; box-shadow: 1px 1px 4px #000;">
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <table id="FourthFlt" cellpadding="11" cellspacing="11">
                                                    <tr>
                                                        <td colspan="2">
                                                            <input id="Title4" type="text" style="border: none; width: 110px; float: left;" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="TextBig">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtflt4" runat="server"  Width="92px"></asp:TextBox>
                                                        </td>
                                                        <td colspan="2">
                                        ...
                                        <tr>
                                            <td>
                                                <table id="FifthFlt" cellpadding="11" cellspacing="11">
                                                    <tr>
                                                        <td colspan="2">
                                                            <input id="Title5" type="text" style="border: none; width: 110px; float: left;" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="TextBig">
                                        ...
                                        <tr>
                                            <td>
                                                <table id="SixthFlt" cellpadding="11" cellspacing="11">
                                                    <tr>
                                                        <td colspan="2">
                                                            <input id="Title6" type="text" style="border: none; width: 110px; float: left;" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="TextBig">
