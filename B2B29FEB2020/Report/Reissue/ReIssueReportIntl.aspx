<%@ Page Title="" Language="VB" MasterPageFile="~/MasterAfterLogin.master" AutoEventWireup="false"
    CodeFile="ReIssueReportIntl.aspx.vb" Inherits="Reports_Reissue_ReIssueReportIntl" %>
    ...
    <div class="large-12 medium-12 small-12">
        ...
        <div class="large-8 medium-8 small-12 columns">
            ...
            <div class="large-12 medium-12 small-12">
                ...
                <div class="large-6 medium-6 small-6 large-push-6 medium-push-6">

                    <div class="large-6 medium-6 small-6 large-6 medium-6 columns">
                        <asp:Button ID="btn_result" runat="server" Text="Search Result" />
                    </div>
                    <div class="large-6 medium-6 small-6 large-6 medium-6 columns">
                        <asp:Button ID="btn_export" runat="server" CssClass="button" Text="Export" />
                    </div>
                </div>
                <div class="clear"></div>

                <div style="color: #FF0000" class="large-12 medium-12 small-12">
