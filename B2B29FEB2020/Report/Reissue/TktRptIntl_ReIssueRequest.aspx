<%@ Page Title="" Language="VB" MasterPageFile="~/MasterAfterLogin.master" AutoEventWireup="false"
    CodeFile="TktRptIntl_ReIssueRequest.aspx.vb" Inherits="Reports_Reissue_TktRptIntl_ReIssueRequest" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div align="center">
        <table cellspacing="10" cellpadding="0" border="0" class="tbltbl" width="950px">
            <tr>
                <td align="center" height="50px" style="font-size: 24px; color: #004b91; font-weight: bold;">
                            ...
                            <asp:TemplateField HeaderText="Reject Remark">
                                <ItemTemplate>
                                    <asp:TextBox  ID="txtRemark" runat="server" Height="47px" TextMode="MultiLine"
                                        Width="250px" Visible="false" MaxLength="500"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ControlStyle-Width="100px">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkSubmit" runat="server" OnClick="btnSubmit_Click" Visible="false"
                                        CommandArgument='<%# Eval("Counter") %>' CommandName="submit" OnClientClick="return Validate();"><img src="../../Images/Submit.png" alt="Ok" /></asp:LinkButton><br />
                             ...
                             <asp:BoundField HeaderText="Customer Remarks" DataField="RegardingIssue"  ControlStyle-Width="200px"></asp:BoundField>
