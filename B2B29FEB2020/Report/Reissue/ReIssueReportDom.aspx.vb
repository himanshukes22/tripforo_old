...
Partial Class Reports_Reissue_ReIssueReportDom
    ...
    Public Sub CheckEmptyValue()
        Try
            ...
            Else
                Status = ""
            End If
            pnrds = objDA.GetReIssueDetail(UserID, UserType, FromDate, ToDate, OrderID, PNR, PaxName, TicketNo, Air, AgentID, ExecID, Status, "D")
            'adp.Fill(pnrds)
            Session("pnrds") = pnrds
