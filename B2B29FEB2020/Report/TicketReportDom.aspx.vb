...
Partial Class Reports_TicketReportDom
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                Dim curr_date1 = Now()
                grdds.Clear()
                grdds = ST.USP_GetTicketDetail_Intl(Session("UID").ToString, Session("User_Type").ToString, curr_date, curr_date1, "", "", "", "", "", AgentID, "D", StatusClass.Ticketed)
                'BindGrid(grdds)
                Dim dt As DataTable
                Dim Db As String = ""
                Dim sum As Double = 0
    ...
    Public Sub CheckEmptyValue()
        Try
            ...
            grdds.Clear()
            grdds = ST.USP_GetTicketDetail_Intl(Session("UID").ToString, Session("User_Type").ToString, FromDate, ToDate, OrderID, PNR, PaxName, TicketNo, AirPNR, AgentID, "D", StatusClass.Ticketed)
            BindGrid(grdds)
