...
Partial Class Reports_Refund_CancellationReportDom
    ...
    Public Sub CheckEmptyValue()
        Try
            ...
            Else
                Status = ""
            End If
            pnrds = objDA.GetCancellationDetail(UserID, UserType, FromDate, ToDate, OrderID, PNR, PaxName, TicketNo, Air, AgentID, ExecID, Status, "D")
            Session("pnrds") = pnrds
