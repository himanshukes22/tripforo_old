<%@ Page Title="" Language="VB" MasterPageFile="~/MasterAfterLogin.master" AutoEventWireup="false"
    CodeFile="TktRptIntl_RefundInProcess.aspx.vb" Inherits="Reports_Refund_TktRptIntl_RefundInProcess" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="w80 auto">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td align="left">
                    <h2 style="color: #000">International Accepted Refund Details</h2>
                </td>
            </tr>
            <tr>
                <td class="clear1"></td>
                    ...
                    <asp:GridView ID="InProccess_grdview" runat="server" AllowPaging="False" AllowSorting="True" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Customer Remarks">
                                <ItemTemplate>
                                    <asp:Label ID="lblCustomer" runat="server" Text='<%#Eval("RegardingCancel")%>'></asp:Label></a>
                                </ItemTemplate>
                            </asp:TemplateField>
