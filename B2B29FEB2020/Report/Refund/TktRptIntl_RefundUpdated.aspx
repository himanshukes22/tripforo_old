<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TktRptIntl_RefundUpdated.aspx.vb"
    Inherits="TktRptIntl_RefundUpdated" %>
        ...
        function Validate() {
          ...
          if (document.getElementById("<%=txt_Service.ClientID%>").value == "") {
            ...
            if (document.getElementById("<%=txtRemark.ClientID%>").value == "") {
                alert("Remark can not be blank,please fill the remarks");
                document.getElementById("<%=txt_Service.ClientID%>").focus();
              return false;
          }
