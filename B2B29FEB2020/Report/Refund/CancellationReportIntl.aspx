<%@ Page Title="" Language="VB" MasterPageFile="~/MasterAfterLogin.master" AutoEventWireup="false"
    CodeFile="CancellationReportIntl.aspx.vb" Inherits="Reports_Refund_CancellationReportIntl" %>
    ...
    <div class="large-12 medium-12 small-12">
        ...
        <div class="large-8 medium-8 small-12 columns">
            ...
            <div id="td_Agency" runat="server">
                ...
                <div class="large-3 medium-3 small-9  columns">
                    <%--<asp:TextBox ID="txt_agencyid" runat="server" CssClass="textboxflight"></asp:TextBox>--%><input type="text" id="txtAgencyName" name="txtAgencyName" style="width: 150px" onfocus="focusObj(this);"
                        onblur="blurObj(this);"
            ...
            <div class="laege-6 medium-6 small-12 large-push-6 medium-push-6">
                <div class="laege-6 medium-6 small-12 columns">
                    <asp:Button ID="btn_result" runat="server" Text="Search Result" />
                </div>
                <div class="laege-6 medium-6 small-12 columns">
                    <asp:Button ID="btn_export" runat="server" Text="Export" /></div>
            </div>

            <div style="color: #FF0000" class="laege-12 medium-12 small-12">
                * N.B: To get Today's booking without above parameter,do not fill any field, only click on search your booking.
            </div>
        ...
        <div class="clear1"></div>
        <div class="laege-12 medium-12 small-12">

            <div>
                <asp:UpdatePanel ID="UP" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="grd_report" runat="server" AutoGenerateColumns="False" GridLines="None" CssClass="table table-hover" Font-Size="12px" AllowPaging="true" PageSize="30">
                            <Columns>
                                <asp:TemplateField HeaderText="Credit Node">
                                    <ItemTemplate>
                                        <a target="_blank" href="../Accounts/CreditNodeIntlDetails.aspx?RefundID=<%#Eval("RefundID")%>">
                                ...
                                <asp:TemplateField HeaderText="Executive Update Remark">
                                    <ItemTemplate>
