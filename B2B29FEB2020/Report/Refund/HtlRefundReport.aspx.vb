Imports System.Data
Partial Class SprReports_Refund_HtlRefundReport
        ...
        Try
            ...
            If Not IsPostBack Then
                If Session("User_Type") <> "AGENT" And Session("User_Type") <> "EXEC" Then
                    ...
                    ddl_ExecID.DataBind()
                End If
                BindSales(HtlST.HotelRefundRpt("", "", "", "", "", "", "", "", "", Session("UID").ToString(), Session("User_Type").ToString()))
            End If
    ...
    Protected Function GetReportData() As DataSet
        Dim GrdDS As New DataSet()
        Dim FromDate As String = "", ToDate As String = "", Trip As String = "", ExecID As String = "", Status As String = ""
        Try
            ...
            End If
            GrdDS = HtlST.HotelRefundRpt(FromDate, ToDate, BookingrID, orderID, HtlName, Trip, AgentID, Status, ExecID, Session("UID").ToString(), Session("User_Type").ToString())
        Catch ex As Exception
            ''HtlLibrary.HtlLog.InsertLogDetails(ex)
        End Try
        Return GrdDS
