...
Partial Class Reports_Refund_CancellationReportIntl
    ...
    Public Sub CheckEmptyValue()
        Try
            ...
            pnrds = objDA.GetCancellationDetail(UserID, UserType, FromDate, ToDate, OrderID, PNR, PaxName, TicketNo, Air, AgentID, ExecID, Status, "I")
            Session("pnrds") = pnrds
    ...
    Private Sub BindGrid()
        ...
        Try
            ...
            Dim curr_date1 = Now()
            pnrds = objDA.GetCancellationDetailCurrent(Session("User_Type"), Session("UID"), curr_date, curr_date1, "I")
            Session("pnrds") = pnrds
            grd_report.DataSource = pnrds
            grd_report.DataBind()
        Catch ex As Exception
