...
Partial Class SprReports_Admin_CancelTicketResponse
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                dt = getCancelREQRES(fromdate, todate, Nothing, Nothing)
        ...
        End Try
    End Sub
    Private Function getCancelREQRES(ByVal fromdate As String, ByVal todate As String, ByVal orderid As String, ByVal agentid As String) As DataTable
        ...
        Try
            ...
            adp.SelectCommand.Parameters.AddWithValue("@tblRef", "CanReqRes")
            adp.Fill(dt)
        Catch ex As Exception
    ...
    Protected Sub btn_result_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_result.Click
        Try
            ...
            Else
                orderid = Nothing
            End If
            dt = getCancelREQRES(fromdate, todate, orderid, agentid)
            If (dt.Rows.Count > 0) Then
                grdfailed.DataSource = dt
                grdfailed.DataBind()
            End If
