<%@ Page Language="VB" MasterPageFile="~/MasterPageForDash.master" AutoEventWireup="false" CodeFile="AgentHtlMarkup.aspx.vb" Inherits="SprReports_Agent_AgentHtlMarkup" %>
            ...
            <div class="col-md-10" style="padding-left: 100px;">
                <div class="form-inlines">
                    <div class="form-groups">
                        <label>Star</label>
                        <asp:DropDownList runat="server" TabIndex="1" ID="ddlStar" class="form-control">
                    ...
                    <div class="form-groups">
                        <label>Country</label>
                        <input type="text" name="TR_Country" id="TR_Country" value="ALL" placeholder="Country"  class="form-control" />
                        <input type="hidden" id="TR_Country1" name="TR_Country1" value="" />
                    </div>
                    <div class="form-groups">
                        <label>City Name</label>
                        <input type="text" name="htlCity" id="htlCity" value="ALL" placeholder="City Name" class="form-control" />
                        <input type="hidden" id="htlcitylist" name="htlcitylist" value="" />
                    </div>
                   
                    <div class="form-groups">
                        <label>Markup Amount</label>
                       <asp:TextBox ID="txtAmt" runat="server" class="form-control" placeholder="Markup Amount" onKeyPress="return checkit(event)" MaxLength="4"></asp:TextBox>
                    </div>
                     <div class="form-groups ">
                    ...
                    <div id="NoRecard" runat="server" class="form-groups"></div>

                </div>
            </div>
            <div class="col-md-2">
                <asp:Button ID="btn_Submit" runat="server" class="buttonfltbks" Text="New Entry" OnClientClick="return MarkupValidation()" />
                <asp:Button ID="btn_Search" runat="server" Text="Search" class="buttonfltbk" />
            ...
            <asp:UpdatePanel ID="BlockAirlineUpdPanel" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="GrdMarkup" runat="server" AllowSorting="True" AutoGenerateColumns="False"  CssClass="table table-hover" GridLines="None" Font-Size="12px"  AlternatingRowStyle-CssClass="alt"
                        ...
                        <Columns>
                            <asp:BoundField DataField="AgentID" HeaderText="AGENT ID" ReadOnly="true"  Visible="false"/>
