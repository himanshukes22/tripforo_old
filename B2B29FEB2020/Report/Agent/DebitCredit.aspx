<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DebitCredit.aspx.vb" Inherits="SprReports_Agent_DebitCredit" %>
    ...
    <div>
        ...
        <asp:UpdatePanel ID="UP" runat="server">
            <ContentTemplate>
                                                        ...
                                                        <td colspan="2">
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td style="font-family: arial, Helvetica, sans-serif; font-weight: bold; color: #000000;
                                                                        padding-left: 10px;display:none;" width="90px">
                                                                        Upload Type:
                                                                    </td>
                                                                    <td width="105px" style="display:none;">
                ...
                <asp:HiddenField ID="HiddenStaffUserId" runat="server" />
