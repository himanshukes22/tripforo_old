<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageForDash.master" AutoEventWireup="true" CodeFile="ProxyPaxUpdate.aspx.cs" Inherits="Report_Proxy_ProxyPaxUpdate" %>
        ...
        <div class="inner-box" style="padding:15px;">
                        ...
                        <asp:DropDownList ID="ddl_Status" CssClass="theme-search-area-section-input" runat="server">
                           <asp:ListItem>Select Status</asp:ListItem>
                            <asp:ListItem Value="IN-PROCESS">IN-PROCESS</asp:ListItem>
                                    <asp:ListItem Value="QUOTED ACCEPTED">QUOTED ACCEPTED</asp:ListItem>
                                    <asp:ListItem Value="REQUEST ACCEPTED">REQUEST ACCEPTED</asp:ListItem>
                                    <asp:ListItem Value="QUOTED REJCECTED">QUOTED REJCECTED</asp:ListItem>
                                    <asp:ListItem Value="REQUEST REJCECTED">REQUEST REJCECTED</asp:ListItem>
                        </asp:DropDownList>
                                </div>
                            </div>
                    </div>
            ...
            <div class="row">
              ...
              <div class="btn-view col-md-3">
                <asp:LinkButton ID="btn_search" OnClick="btn_search_Click" runat="server" Text="View Detail" CssClass="btn cmn-btn" ToolTip="Search by Date"><i class="fa fa-search" style="font-size: 10px;"></i>  Search</asp:LinkButton>
              </div>
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Proxy ID">
                                ...
                                <asp:Label ID="Pid" runat="server" Text='<%# Eval("ProxyID") %>'></asp:Label>
                                    ...
                                    <a href='ProxyEmp.aspx?Proxyid=<%# Eval("ProxyID") %>&Adult=<%# Eval("Adult") %>&Child=<%# Eval("Child") %>&Infrant=<%# Eval("Infrant") %>&TravelType=<%# Eval("TravelType") %>&AgentID=<%# Eval("AgentID") %>'
