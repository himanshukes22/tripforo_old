<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FailedBusTicket.aspx.vb"
    Inherits="BS_Admin_FailedBusTicket" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Failed Bus Report</title>
...
<body>
    ...
    <div>
        <table cellspacing="3" cellpadding="3" align="center" border='0' style='border: 1px solid #ccc; margin-top:10px; box-shadow: 1px 1px 5px #333; padding: 10px; border-radius: 10px; -o-border-radius: 10px; -moz-border-radius: 10px; -webkit-border-radius: 10px; width:50%; margin:auto; text-align:left;'>
            <tr>
    ...
    <div align="center">
        <asp:GridView ID="grdfailed" AutoGenerateColumns="false" runat="server" Width="80%"
            CssClass="GridViewStyle" GridLines="None">
            <Columns>
                <asp:BoundField HeaderText="ORDER&nbsp;ID" DataField="ORDERID" />
                <asp:BoundField HeaderText="BLOCK&nbsp;KEY" DataField="BLOCK_KEY" />
                <asp:BoundField HeaderText="TIN&nbsp;NO" DataField="TIN_NO" />
                <asp:BoundField HeaderText="ORDER&nbsp;ID" DataField="ORDERID" />
                <asp:BoundField HeaderText="BOOKING&nbsp;REQUEST" DataField="BOOK_REQUEST" />
                <asp:BoundField HeaderText="BOOKING&nbsp;RESPONSE" DataField="BOOK_RESPONSE" />
                <asp:BoundField HeaderText="AGENT&nbsp;ID" DataField="AGENTID" />
