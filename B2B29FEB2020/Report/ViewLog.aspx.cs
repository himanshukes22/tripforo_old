...
public partial class SprReports_ViewLog : System.Web.UI.Page
{
    string constr = ConfigurationManager.ConnectionStrings["myAmdDB"].ConnectionString;
    SqlDataReader dr = null;
    string OrderID = "", PNRNo = "", ProviderName = "";
    ...
    public string SERes(string GetXML_Details, string val)
    {
    ...
    {
        //val = val.Replace("[", "").Trim().Replace("{", "").Trim().Replace("]", "").Trim().Replace("}", "").Trim().Replace(":","");
