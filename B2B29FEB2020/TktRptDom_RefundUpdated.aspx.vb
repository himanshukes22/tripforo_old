            ...
            For Each row As GridViewRow In grd_Pax.Rows
                ...
                If (Status = 0) Then
                    ...
                    If True Then
                        ...
                        STDom.insertLedgerDetails(lbluser, lblagencyname, lblorderId, lblpnr, lblTktNo, "", "Offline PG", "", Session("UID").ToString, Request.UserHostAddress, 0, _
                    ...
                    Else
                        ...
                        result = "Ticket Refund was not Sucessful, Please Retry"
                    End If
