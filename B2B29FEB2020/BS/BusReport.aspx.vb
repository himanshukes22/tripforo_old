...
Partial Class SprReports_BusReport
    ...
    Protected Sub btn_export_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_export.Click
        Try
            ...
            adap.SelectCommand.Parameters.AddWithValue("@LoginID", Session("UID").ToString())
            adap.Fill(DS)
            DS.Tables(0).Columns.Remove(DS.Tables(0).Columns("PROVIDER_NAME"))
            DS.Tables(0).Columns.Remove(DS.Tables(0).Columns("REFUNDEDAMOUNT"))
            DS.Tables(0).Columns.Remove(DS.Tables(0).Columns("CANCELLATIONCHARGE"))
            DS.Tables(0).Columns.Remove(DS.Tables(0).Columns("YATRA_PNR"))
