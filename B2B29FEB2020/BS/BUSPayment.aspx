<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAfterLogin.master" AutoEventWireup="true" CodeFile="BUSPayment.aspx.cs" Inherits="BS_BUSPayment" %>
        ...
        <table id="tblMainGroupFrame_final" width="100%" cellspacing="0" cellpadding="10" style="width: 100%; border-collapse: collapse;" border="1">
            ...
            <tr id="tr_pgmode" runat="server">
                <td colspan="5" align="left">
                    ...
                    <asp:Button ID="btn_payment" runat="server" OnClick="btn_payment_Click" Text="Pay" CssClass="buttonfltbk" Width="100px" />
                </td>
            </tr>
        </table>
    </div>
