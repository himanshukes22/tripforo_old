<%@ Page Title="" Language="VB" MasterPageFile="~/MasterAfterLogin.master" AutoEventWireup="false"
    CodeFile="FltResultO.aspx.vb" Inherits="FlightDom_FltResultO"  %>
...
<script type="text/javascript">
    ...
    queryObj["txtDepCity1"]='<%=Session("SearchQuery")("Origin")%>';
    queryObj["hidtxtDepCity1"]='<%=Session("SearchQuery")("hidOrigin")%>';
    queryObj["txtArrCity1"]='<%=Session("SearchQuery")("Destination")%>';
    queryObj["hidtxtArrCity1"]='<%=Session("SearchQuery")("hidDestination")%>';
    queryObj["txtDepDate"]='<%=Session("SearchQuery")("Depdate")%>';
    queryObj["txtRetDate"]='<%=Session("SearchQuery")("retDate")%>';
