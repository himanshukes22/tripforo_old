...
Partial Class FlightDom_CustomerInfo
    ...
    Dim ItqApiSSR, ItqApiSSRIB, ItqApiSSRSTF As New List(Of GALWS.ITQAirApi.ItqAirApiSSR)()
        ...
        Try
            ...
            Else
                If Not Page.IsPostBack Then
                    ...
                    If Provider = "FDD" And Convert.ToString(Session("SearchCriteriaUser")) <> Convert.ToString(Request.Url) Then
                        Session("SearchCriteriaUser") = Request.Url
                        Session("BookIng") = "FALSE"
                        Session("IntBookIng") = "FALSE"
                    End If
                    ...
                    If Provider.Trim.ToUpper = "TB" Or Provider.Trim.ToUpper = "TQ" Or Provider.Trim.ToUpper = "YA" Or Provider.Trim.ToUpper = "AK" Or (Provider.Trim.ToUpper = "LCC" And VCOB = "IX") Then
                    ...
                    Dim Eq As Integer
                    Try
                        If InStr(VCOBSPL, "Special") = 0 And (VCOB = "SG" Or VCOB = "6E" Or VCOB = "G8") And Provider.Trim().ToUpper() <> "TB" And Provider.Trim().ToUpper() <> "AK" And Provider.Trim().ToUpper() <> "TQ" Then
                            If (VCOB = "SG") Then
                    ...
                    End If
                    If Provider.Trim().ToUpper() = "TQ" Then
                        Try
                            Dim objitapi As New GALWS.ITQAirApi.BookingAndAddPassanger()
                            ItqApiSSR = objitapi.ItqAirApiSpecialService(ItqApiSSR, Constr, OBFltDs.Tables(0))

                            If (Convert.ToString(OBFltDs.Tables(0).Rows(0)("RESULTTYPE").ToLower().ToString())) = "sme" Then
                                'gstfor_TBO.Style.Add("display", "block")
                                'ScriptManager.RegisterStartupScript(Me, Page.GetType, "Script", "validategst();", True)
                                'gstfield.Style.Add("display", "none")
                        ...
                        Catch ex As Exception
                            ITZERRORLOG.ExecptionLogger.FileHandling("Pagelode_ItqAPISpecialService", "Error_001", ex, "Flight")
                            book.Visible = False
                        End Try
                    End If
    ...
    Private Sub getFarebreakup(ByVal OBDS As DataSet, ByVal Ft As String, ByVal IBDS As DataSet)
        ...
        Try
            strPax = strPax & "<div class='theme-sidebar-section _mb-10'><h5 class='theme-sidebar-section-title'>Booking Summary</h5>"
            strPax = strPax & "<ul class='theme-sidebar-section-summary-list'>"
            strPax = strPax & "<li>Adult - " & OBDS.Tables(0).Rows(0)("Adult") & ", Child - " & OBDS.Tables(0).Rows(0)("Child") & " , Infant - " & OBDS.Tables(0).Rows(0)("Infant") & "</li>"
            strPax = strPax & "</ul>"
            strPax = strPax & "</div>"

            strPax = strPax & "<div class='theme-sidebar-section _mb-10' style='display:block;'>"
            ...
            strPax = strPax & "<h5 class='theme-sidebar-section-title'>OutBound Fare</h5>" & fareBreakupfun(OBDS, "OutBound")
            If Ft = "InBound" Then
                strPax = strPax & "<div class='theme-sidebar-section _mb-10'> "
                strPax = strPax & "<h5 class='theme-sidebar-section-title'>InBound Fare</h5>" & fareBreakupfun(IBDS, Ft)
    ...
    Private Function fareBreakupfun(ByVal OFareDS As DataSet, ByVal Ft As String) As String
        Try
            ...
            strFare = strFare & "<h5 class='theme-sidebar-section-charges-item-title'>Adult Fare</h5>"
            'strFare = strFare & "<p class='theme-sidebar-section-charges-item-subtitle'></p>"
            strFare = strFare & "<p class='theme-sidebar-section-charges-item-price'>₹ " & OFareDS.Tables(0).Rows(0)("AdtBFare") & "</p>"
            strFare = strFare & "</li>"
            strFare = strFare & "<li class='theme-sidebar-section-charges-item'>"
            strFare = strFare & "<h5 class='theme-sidebar-section-charges-item-title'>Fuel Surcharge</h5>"
            strFare = strFare & "<p class='theme-sidebar-section-charges-item-subtitle'></p>"
            strFare = strFare & "<p class='theme-sidebar-section-charges-item-price'>₹ " & yq & "</span></p>"
            strFare = strFare & "</li>"
            strFare = strFare & "<li class='theme-sidebar-section-charges-item'>"
            ...
            strFare = strFare & "<p class='theme-sidebar-section-charges-item-subtitle'></p>"
            strFare = strFare & "<p class='theme-sidebar-section-charges-item-price'>₹ " & (OFareDS.Tables(0).Rows(0)("AdtFare") + tcperpax) & "</p>"
            strFare = strFare & "</li>"
            strFare = strFare & "</ul>"
            strFare = strFare & "</div>"
            ...
            If Child > 0 Then
                ...
                strFare = strFare & "<li class='theme-sidebar-section-charges-item'>"
                strFare = strFare & "<div class='li'>"
                strFare = strFare & "<h5 class='theme-sidebar-section-charges-item-title'>Child Fare</h5>"
                'strFare = strFare & "<p class='theme-sidebar-section-charges-item-subtitle'></p>"
                strFare = strFare & "<p class='theme-sidebar-section-charges-item-price'>₹ " & OFareDS.Tables(0).Rows(0)("ChdBFare") & "</p>"
                strFare = strFare & "</li>"
                strFare = strFare & "<li class='theme-sidebar-section-charges-item'>"
                strFare = strFare & "<h5 class='theme-sidebar-section-charges-item-title'>Fuel Surcharge</h5>"
                strFare = strFare & "<p class='theme-sidebar-section-charges-item-subtitle'></p>"
            ...
            If Infant > 0 Then
                ...
                strFare = strFare & "<li class='theme-sidebar-section-charges-item'>"
                strFare = strFare & "<div class='li'>"
                strFare = strFare & "<h5 class='theme-sidebar-section-charges-item-title'>Infant Fare</h5>"
                'strFare = strFare & "<p class='theme-sidebar-section-charges-item-subtitle'></p>"
                strFare = strFare & "<p class='theme-sidebar-section-charges-item-price'>₹ " & OFareDS.Tables(0).Rows(0)("InfBFare") & "</p>"
                strFare = strFare & "</li>"
            ...
            If (OFareDS.Tables(0).Rows(0)("IsCorp") = True) Then
                ...
                strFare = strFare & "<p class='theme-sidebar-section-charges-item-subtitle'></p>"
                strFare = strFare & "<p class='theme-sidebar-section-charges-item-price'>₹ " & OFareDS.Tables(0).Rows(0)("TOTMGTFEE") & "</p>"
                strFare = strFare & "</li>"
            Else
                strFare = strFare & "<li class='theme-sidebar-section-charges-item'>"
                strFare = strFare & "<h5 class='theme-sidebar-section-charges-item-title'>Transaction Fee</h5>"
                strFare = strFare & "<p class='theme-sidebar-section-charges-item-subtitle'></p>"
                strFare = strFare & "<p class='theme-sidebar-section-charges-item-price'>₹ " & OFareDS.Tables(0).Rows(0)("TFee") & "</p>"
                strFare = strFare & "</li>"
                strFare = strFare & "<li class='theme-sidebar-section-charges-item'>"
                strFare = strFare & "<h5 class='theme-sidebar-section-charges-item-title'>Transaction Charge</h5>"
                strFare = strFare & "<p class='theme-sidebar-section-charges-item-subtitle'></p>"
                strFare = strFare & "<p class='theme-sidebar-section-charges-item-price'>₹ 0</p>"
                strFare = strFare & "</li>"
                strFare = strFare & "</ul>"
                strFare = strFare & "</div>"
            ...
            If Ft = "OutBound" Then
                strFare = strFare & "<div id='trtotfare'  style='cursor:pointer;color: #004b91'>"  'onmouseover=funcnetfare('block','trnetfare'); onmouseout=funcnetfare('none','trnetfare');
            ElseIf Ft = "InBound" Then
                strFare = strFare & "<div id='trtotfareR' style='cursor:pointer;color: #004b91'>"  'onmouseover=funcnetfare('block','trnetfareR'); onmouseout=funcnetfare('none','trnetfareR');
            End If
            strFare = strFare & "<div class='theme-sidebar-section-charges'>"
            strFare = strFare & "<ul class='theme-sidebar-section-charges-list'>"
            strFare = strFare & "<li class='theme-sidebar-section-charges-item'>"
            ''strFare = strFare & "<div class='pr-l1' style='font-size:9px;'>Gross Total(" & Adult & " Adt," & Child & " Chd," & Infant & " Inf)</div>"
            strFare = strFare & "<h5 class='theme-sidebar-section-charges-item-title' style='font-size:16px;color:red;'>Gross Total</h5>"
            strFare = strFare & "<p class='theme-sidebar-section-charges-item-subtitle'></p>"
            'strFare = strFare & "<div style='border-bottom:1px solid #eee;'></div>"
            strFare = strFare & "<p class='theme-sidebar-section-charges-item-price'>₹ " & OFareDS.Tables(0).Rows(0)("totFare") & "</p>"
            strFare = strFare & "</li>"
            strFare = strFare & "</ul>"
            strFare = strFare & "</div>"
            If Ft = "OutBound" Then
                strFare = strFare & "<div id='trnetfare' class='' style='display:none;'>" 'id='trnetfare'
            ElseIf Ft = "InBound" Then
                strFare = strFare & "<div id='trnetfareR'  class=''   style='display:none;'>"  'id='trnetfareR'
            End If
            strFare = strFare & "<div class='theme-sidebar-section-charges'>"
            strFare = strFare & "<ul class='theme-sidebar-section-charges-list'>"
            strFare = strFare & "<li class='theme-sidebar-section-charges-item'>"
            strFare = strFare & "<h5 class='theme-sidebar-section-charges-item-title'>Commission</h5>"
            strFare = strFare & "<p class='theme-sidebar-section-charges-item-subtitle'></p>"
            strFare = strFare & "<p class='theme-sidebar-section-charges-item-price'>₹ " & OFareDS.Tables(0).Rows(0)("DisCount") & "</p>"
            strFare = strFare & "</li>"
            ...
            strFare = strFare & "<li class='theme-sidebar-section-charges-item'>"
            strFare = strFare & "<h5 class='theme-sidebar-section-charges-item-title'>TDS</h5>"
            strFare = strFare & "<p class='theme-sidebar-section-charges-item-subtitle'></p>"
            strFare = strFare & "<p class='theme-sidebar-section-charges-item-price'>₹ " & Totaltds & "</p>"
            strFare = strFare & "</li>"

            strFare = strFare & "<li class='theme-sidebar-section-charges-item'>"
            strFare = strFare & "<h5 class='theme-sidebar-section-charges-item-title'>Net Fare</h5>"
            strFare = strFare & "<p class='theme-sidebar-section-charges-item-subtitle'></p>"
            strFare = strFare & "<p class='theme-sidebar-section-charges-item-price'>₹ " & OFareDS.Tables(0).Rows(0)("netFare") & "</p>"
            strFare = strFare & "</li>"
            strFare = strFare & "</ul>"
            strFare = strFare & "</div>"
                    ...
                    If AgencyDs.Tables(0).Rows(0)("Agent_Status").ToString.Trim <> "NOT ACTIVE" And AgencyDs.Tables(0).Rows(0)("Online_tkt").ToString.Trim <> "NOT ACTIVE" Then
                        ...
                        If FltHdrO.Tables.Count > 0 Then
                            If FltHdrO.Tables(0).Rows.Count = 0 Then
                                ...
                                If ((VCOB = "SG" Or VCOB = "6E" Or VCOB = "G8" Or VCOB = "IX") And InStr(VCOBSPL, "Special") = 0) Or Prvdr.Trim().ToUpper() = "TB" Or Prvdr.Trim().ToUpper() = "YA" Or Prvdr.Trim().ToUpper() = "AK" Or Prvdr.Trim().ToUpper() = "TQ" Then
            ...
            For Each rw As RepeaterItem In Repeater_Adult.Items
                ...
                If (String.IsNullOrEmpty(seat)) Then
                    If counter <= Infant Then
                        objDA.insertPaxDetails(trackid, ddl_ATitle.SelectedValue, txtAFirstName.Text.Trim(), txtAMiddleName.Text.Trim(), txtALastName.Text.Trim(),
                         "ADT", DOB, txt_ANumber.Text.Trim(), txt_AAirline.Value.Trim(), ddl_AMealPrefer.SelectedValue, ddl_ASeatPrefer.SelectedValue,
                         FirstPax, "", gender, "", "", "", "")
                    Else
                ...
                Else
                    If counter <= Infant Then
                        objDA.insertPaxDetails(trackid, ddl_ATitle.SelectedValue, txtAFirstName.Text.Trim(), txtAMiddleName.Text.Trim(), txtALastName.Text.Trim(),
                         "ADT", DOB, txt_ANumber.Text.Trim(), txt_AAirline.Value.Trim(), ddl_AMealPrefer.SelectedValue, seat,
                         FirstPax, "", gender, "", "", "", "")
                    Else
            ...
            If Child > 0 Then
                For Each rw As RepeaterItem In Repeater_Child.Items
                    ...
                    If (String.IsNullOrEmpty(seat)) Then
                        ...
                        objDA.insertPaxDetails(trackid, ddl_CTitle.SelectedValue, txtCFirstName.Text.Trim(), txtCMiddleName.Text.Trim(), txtCLastName.Text.Trim(),
                         "CHD", DOB, "", "", ddl_CMealPrefer.SelectedValue, ddl_CSeatPrefer.SelectedValue,
                         "false", "", gender, "", "", "", "")
                    Else
                        objDA.insertPaxDetails(trackid, ddl_CTitle.SelectedValue, txtCFirstName.Text.Trim(), txtCMiddleName.Text.Trim(), txtCLastName.Text.Trim(),
                       "CHD", DOB, "", "", ddl_CMealPrefer.SelectedValue, seat,
                       "false", "", gender, "", "", "", "")
                    End If
                    Dim objs As STD.BAL.FlightCommonBAL = New FlightCommonBAL(ConfigurationManager.ConnectionStrings("myAmdDB").ConnectionString)
                    If seatlist.Count > 0 Then
    ...
    Protected Sub Repeater_Adult_ItemCreated(ByVal sender As Object, ByVal e As RepeaterItemEventArgs)
        ...
        If (VCOB = "SG" Or VCOB = "6E" Or VCOB = "G8") And Provider.Trim.ToUpper <> "TQ" And InStr(VCOBSPL, "Special") = 0 Then ''And Provider.Trim.ToUpper <> "TB" And Provider.Trim.ToUpper <> "YA" Then
            Try
        ...
        ElseIf Provider.Trim.ToUpper = "TQ" Then
            Try
                Dim OBFltDs As DataSet
                OBFltDs = objDA.GetFltDtls(OBTrackId, Session("UID").ToString())
                ...
                Dim ddl As DropDownList = TryCast(e.Item.FindControl("Ddl_A_EB_Ob"), DropDownList)
                '  ddl.Items.Add(New ListItem(baglist(i).Description + "--INR" + baglist(i).Amount.ToString(), baglist(i).Code + ":" + baglist(i).Description + "_" + baglist(i).Origin + "_" + baglist(i).Destination + ":" + baglist(i).Amount.ToString() + ":" + Adti.ToString()))
                Dim baglist As List(Of GALWS.ITQAirApi.ItqAirApiSSR) = (From ssr In ItqApiSSR Where ssr.SSRType = "Baggage" And ssr.Origin = OBFltDs.Tables(0).Rows(0)("DepartureLocation").ToString().Trim() And ssr.Destination = OBFltDs.Tables(0).Rows(0)("ArrivalLocation").ToString().Trim() Order By ssr.Amount).ToList()
                Dim Meallist As List(Of GALWS.ITQAirApi.ItqAirApiSSR) = (From ssr In ItqApiSSR Where ssr.SSRType = "Meal" And ssr.Origin = OBFltDs.Tables(0).Rows(0)("DepartureLocation").ToString().Trim() And ssr.Destination = OBFltDs.Tables(0).Rows(0)("ArrivalLocation").ToString().Trim() Order By ssr.Amount).ToList()
                ddl.Items.Add(New ListItem("---Select Excess Bagage Options---", "select"))
                For i As Integer = 0 To baglist.Count - 1
                    ddl.Items.Add(New ListItem("Excess Baggage " & baglist(i).Weight & " KG--INR" + baglist(i).Amount.ToString(), baglist(i).Code + ":" + baglist(i).Description & "_" & baglist(i).WayType & "_" + baglist(i).Weight & "_" & baglist(i).Origin & "_" & baglist(i).Destination & "_ADT:" & baglist(i).Amount.ToString() & ":" & Adti.ToString()))
                Next
                ...
                ddl2.Items.Add(New ListItem("---Select Meal Options---", "select"))
                For i As Integer = 0 To Meallist.Count - 1
                    ddl2.Items.Add(New ListItem(Meallist(i).AirlineDescription & "--INR" + Meallist(i).Amount.ToString(), Meallist(i).Code & ":" + Meallist(i).Description & "_" & Meallist(i).WayType & "_" + Meallist(i).AirlineDescription & "_" & Meallist(i).Origin & "_" & Meallist(i).Destination & "_ADT:" & Meallist(i).Amount.ToString() & ":" & Adti.ToString()))
                Next
                ddl2.DataBind()
        ...
        If (VCIB = "SG" Or VCIB = "6E" Or VCIB = "G8") And InStr(VCIBSPL, "Special") = 0 And ProviderIB.Trim.ToUpper <> "TQ" Then ''And ProviderIB.Trim.ToUpper <> "TB" And ProviderIB.Trim <> "" And ProviderIB.Trim.ToUpper <> "YA" Then
            Try
        ...
        ElseIf ProviderIB.Trim.ToUpper = "TB" Or (FLT_STAT = "RTF" And Provider.Trim.ToUpper = "TB") Then
            ...
            End Try
        ElseIf ProviderIB.Trim.ToUpper = "TQ" Or (FLT_STAT = "RTF" And Provider.Trim.ToUpper = "TQ") Then
            Try
                Dim IBFltDs As DataSet
                IBFltDs = objDA.GetFltDtls(IBTrackId, Session("UID").ToString())
                Dim ddl_Ib As DropDownList = TryCast(e.Item.FindControl("Ddl_A_EB_Ib"), DropDownList)
                Dim div_Ib As System.Web.UI.HtmlControls.HtmlGenericControl = TryCast(e.Item.FindControl("div_ADT_Ib"), HtmlControls.HtmlGenericControl)
                Dim baglist As List(Of GALWS.ITQAirApi.ItqAirApiSSR) = (From ssr In ItqApiSSR Where ssr.SSRType = "Baggage" And ssr.Origin = IBFltDs.Tables(0).Rows(0)("DepartureLocation").ToString().Trim() And ssr.Destination = IBFltDs.Tables(0).Rows(0)("ArrivalLocation").ToString().Trim() Order By ssr.Amount).ToList()
                Dim Meallist As List(Of GALWS.ITQAirApi.ItqAirApiSSR) = (From ssr In ItqApiSSR Where ssr.SSRType = "Meal" And ssr.Origin = IBFltDs.Tables(0).Rows(0)("DepartureLocation").ToString().Trim() And ssr.Destination = IBFltDs.Tables(0).Rows(0)("ArrivalLocation").ToString().Trim() Order By ssr.Amount).ToList()

                ddl_Ib.Items.Add(New ListItem("---Select Excess Bagage Options---", "select"))
                For i As Integer = 0 To baglist.Count - 1
                    ddl_Ib.Items.Add(New ListItem("Excess Baggage " & baglist(i).Weight & " KG--INR" + baglist(i).Amount.ToString(), baglist(i).Code + ":" + baglist(i).Description & "_" & baglist(i).WayType & "_" + baglist(i).Weight & "_" & baglist(i).Origin & "_" & baglist(i).Destination & "_ADT:" & baglist(i).Amount.ToString() & ":" & Adti.ToString()))
                Next
                ...
                ddl2_Ib.Items.Add(New ListItem("---Select Meal Options---", "select"))
                For i As Integer = 0 To Meallist.Count - 1
                    ddl2_Ib.Items.Add(New ListItem(Meallist(i).AirlineDescription & "--INR" + Meallist(i).Amount.ToString(), Meallist(i).Code & ":" + Meallist(i).Description & "_" & Meallist(i).WayType & "_" + Meallist(i).AirlineDescription & "_" & Meallist(i).Origin & "_" & Meallist(i).Destination & "_ADT:" & Meallist(i).Amount.ToString() & ":" & Adti.ToString()))
                Next
                ddl2_Ib.DataBind()
...
LAB2:
    ...
    Private Function SELL_SSR(ByVal TrackId As String) As String
        ...
        Try
            ...
            Dim FltDs As DataSet = objDA.GetFltDtls(TrackId, Session("UID"))
            Dim PaxDs As DataSet = objDA.GetPaxDetails(TrackId)
            Dim GSTdet As DataSet
            GSTdet = objSql.GetGstTQ(TrackId)
            Dim VC As String = FltDs.Tables(0).Rows(0)("ValiDatingCarrier").ToString.Trim()
            Dim OriginalTF As Decimal = Convert.ToDecimal(FltDs.Tables(0).Rows(0)("OriginalTF").ToString())
            Dim MBDT As DataSet = objSql.Get_MEAL_BAG_FareDetails(FltDs.Tables(0).Rows(0)("Track_id").ToString(), "")
            Dim MBPR As Decimal = 0, MealPr As Decimal = 0, BgPr As Decimal = 0
            ...
            If (MBPR > 0 Or (VC = "SG" AndAlso objInputs.Cabin = "BUSINESS")) Then
                If (FltDs.Tables(0).Rows(0)("Provider") = "TQ") Then
                    Dim AgencyDs As DataSet
                    AgencyDs = objDA.GetAgencyDetails(Session("UID"))
                    ...
                    Dim CredencialDs As DataSet = objSql.GetCredentials("TQ", Convert.ToString(FltDs.Tables(0).Rows(0)("RESULTTYPE")), "D")
                    SSRPRICE = objItqApi.AddPassanger(GSTdet.Tables(0), CredencialDs.Tables(0).Rows(0)("BkgServerUrlOrIP").ToString(), txt_MobNo.Text, txt_Email.Text, FltDs.Tables(0), MBDT.Tables(0), PaxDs, AgencyDs, OriginalTF, SeatListO, Xml)
                Else
                    If (VC = "6E") Then
                ...
                End If
            Else
                If (VC = "AK" And FltDs.Tables(0).Rows(0)("Provider") = "TQ") Then
                    Dim objAirAsia As New GALWS.AirAsia.AirAsiaSellSSR_AssignSeat()
                    Dim CredencialDs As DataSet = objSql.GetCredentials("AK", Convert.ToString(FltDs.Tables(0).Rows(0)("RESULTTYPE")), "D")
                    SSRPRICE = objAirAsia.SellSSR(CredencialDs, FltDs.Tables(0), ConfigurationManager.ConnectionStrings("myAmdDB").ConnectionString, MBDT.Tables(0), Xml)
                    Try
                    ...
                    Catch ex As Exception
                        SSRPRICE = "FAILURE"
                    End Try
                ElseIf (FltDs.Tables(0).Rows(0)("Provider") = "TQ") Then
                    Try
                        Dim AgencyDs As DataSet
                        AgencyDs = objDA.GetAgencyDetails(Session("UID"))
                        Dim IFLT As FlightCommonBAL = New FlightCommonBAL(ConfigurationManager.ConnectionStrings("myAmdDB").ConnectionString)
