<%@ WebHandler Language="VB" Class="fareDetails" %>

Imports System
Imports System.Web
Imports System.Data
Public Class fareDetails : Implements IHttpHandler, IReadOnlySessionState
   
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        context.Response.ContentType = "text/plain"
        context.Response.Cache.SetCacheability(HttpCacheability.NoCache)
        context.Response.Write(GetFareDetails(context.Request("triptype"), context.Request("lin")))
        
    End Sub
    
    Public Function GetFareDetails(ByVal triptype As String, ByVal lin As String) As String
        Dim ObjCommPlb As New clsCalcCommAndPlb
        Dim DomFareDetails As Hashtable
        DomFareDetails = ObjCommPlb.getRTFareDetails(lin, triptype)
        Dim fbStr As String = ""
        Dim adt As Integer = 0, chd As Integer = 0, inf As Integer = 0
        Dim AirArray As Array
        AirArray = HttpContext.Current.Session("depDV").Select("LineItemNumber='" & lin & "'", "")
        adt = (AirArray(0)("Adult"))
        chd = (AirArray(0)("Child"))
        inf = (AirArray(0)("Infant"))
        
        fbStr = fbStr & "<table width='500' cellspacing='0' cellpadding='0' style='font-size:11px; font-family:verdana; padding-left:5px'>" 'border:3px #666666 solid; background:#FFFFA8;
        fbStr = fbStr & "<tr>"
        ...
        fbStr = fbStr & "<td width='16%' align='center'>&nbsp;</td>" '<img src='../images/close.gif' onclick=javascript:HideContent('divfareDetails'); return true; />
        fbStr = fbStr & "</tr>"
