        ...
        if (this.rel != null) {
            ...
            if (O.items.length > 0) {
                ...
                for (var i = 0; i < O.items.length; i++) {
                    ...
                    if (O.items[0].Trip == "I") {
                        ftme = O.items[i].TripCnt + '<br/><img src="' + UrlBase + 'Images/duration.png" />';
                    }
           ...
           .Select(function (item) { return item });
                ...
                if (R.items.length > 0) {
                    ...
                    for (var j = 0; j < R.items.length; j++) {
                        ...
                        if (R.items[0].Trip == "I") {
                            Ftmer = R.items[j].TripCnt + ' <br/><img src="' + UrlBase + 'Images/duration.png" />';;
                        }
...
function DisplayMultipleFares(list, lnNoArray, secNum, fltName, IsRTrip, IsRTF, Index, tripF, mainLineNo) {
    ...
    for (var i = 0; i < lnn.length; i++) {
        ...
        if (i == 0) {
            faredet += '<div value="' + mainLineNo + '" class="' + mainLineNo + '_faredetailmasterall" id="' + OF.items[0].LineNumber + '_faredetailmaster" style="position: relative; top: -17px; float: left;right: 550px;">' + rnr;


            faredet += '<div class="gridViewToolTip cursorpointer lft div_cls"><a><span style="color:oranger !important;">Fare Details  |  </span></a>  </div>';
            faredet += '<div class="gridViewToolTip1 lft hide"  title="' + OF.items[0].LineNumber + '_O" ></div>';
            faredet += '<div class="lft div_cls"><a href="#" id="' + OF.items[0].LineNumber + 'Det" title="' + mainLineNo + '" rel="' + OF.items[0].LineNumber + '"  class="fltDetailslink"><span style="color:oranger !important;">Flight Details  |  </span>  </a></div>';
            faredet += '<div class="lft div_cls"><a href="#" id="' + OF.items[0].LineNumber + 'BagDet"  title="' + mainLineNo + '" rel="' + OF.items[0].LineNumber + '"  class="fltBagDetails"><span style="color:oranger !important;"> Baggage  |  </span>  </a></div>';
            faredet += '<span class="fareRuleToolTip cursorpointer lft" rel="FareRule_' + OF.items[0].LineNumber + '_O" title="' + mainLineNo + '" ><span style="color:oranger !important;"> Cancelation  |  </span> </span><div class="fade"  title="' + OF.items[0].LineNumber + '_O" > &nbsp;</div>';
        ...
        faredet += '<div class="gridViewToolTip cursorpointer lft"><sapan> Fare Details  |  </span></div>';
        faredet += '<div class="gridViewToolTip1 lft"  title="' + OF.items[0].LineNumber + '_O" ></div>';
        faredet += '<div class="lft"><a href="#" id="' + OF.items[0].LineNumber + 'Det" title="' + mainLineNo + '" rel="' + OF.items[0].LineNumber + '"  class="fltDetailslink"><span>Flight Details  |  </span></a></div>';
        faredet += '<div class="lft"><a href="#" id="' + OF.items[0].LineNumber + 'BagDet"  title="' + mainLineNo + '" rel="' + OF.items[0].LineNumber + '"  class="fltBagDetails"><span>Baggage  |  </span></a></div>';
        faredet += '<span class="fareRuleToolTip cursorpointer lft" rel="FareRule_' + OF.items[0].LineNumber + '_O" title="' + mainLineNo + '" ><span>Cancelation  |  </span></span><div class="fade"  title="' + OF.items[0].LineNumber + '_O" > &nbsp;</div>';
