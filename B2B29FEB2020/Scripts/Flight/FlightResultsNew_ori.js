...
ResHelper.prototype.GetFltDetails = function (result) {
    ...
    $('.fltDetailslink').click(function (event) {
        ...
        //   
        if (this.rel != null) {
            //$('#' + this.rel + '_').slideUp();  //Old 
            $('#' + this.title + '_').slideUp();
                ...
                if (OB.items.length > 0) {
                   ...
                   .Select(function (item) { return item });
                    ...
                    if (OF.items.length > 0) {
                        ...
                        result += '<div class="rgt w28"><input type="button"  value="Book_Dev1" class="buttonfltbk rgt" title="' + OB.items[0].LineNumber + '"  id="' + OB.items[0].LineNumber + '_O" /></div>';
                    ...
                    if (OF.items.length > 0) {
                        ...
                        { result += '<div class="w24 lft"><img src="' + UrlBase + 'refundable.png"/><div class="rfnd bld colorp italic hide">Non Refundable</div>'; }
                            ...
                            result += '<div class="large-3 medium-3 small-3 columns passenger hide">' + rnr + '<div class="rfnd bld colorp italic hide">' + rrfnd + '</div>';
                            //debugger;
                            var FAirType = "";
                        ...
                        ///result += '';
                        if ($.trim(Provider).search("SFM") > 0) {
                            result += '<div class="price f20 lft colorp hide"> <i clawaitMessagess="fa fa-inr" aria-hidden="true"></i>' + Math.ceil(OF.items[0].TotalFare / 2) + '</div>';
                        }
                        else {
                            result += '<div class="price f20 lft colorp hide"> <i class="fa fa-inr" aria-hidden="true"></i>' + OF.items[0].TotalFare + '</div>';
                        }
                        //result += '<div class="clear"></div>';
                        ...
                        if ((parseInt(OB.items[0].AvailableSeats1) <= 5) && (OB.items[0].ValiDatingCarrier != 'SG')) {
                            result += '<span class="passenger hide" style="color: #004b91;font-size: 12px; padding:2px 5px; border-radius:4px; ">' + OB.items[0].AvailableSeats1 + ' Seat(s) Left!</span>';
                        }
                        ...
                        //Use Price Fare wise                        
                        //result += '<div id="' + OB.items[0].LineNumber + '_Details">';                        
                ...
                if (olnum.search('SFM') < 0 && rlnum.search('SFM') < 0) {
                 ...
                 .Select(function (item) { return item });
                    ...
                    if (Obook[0].AirLineName == Rbook[0].AirLineName && ObookSFM != null && RbookSFM != null && ObookSFM.length != 0 && RbookSFM.length != 0 && Obook[0].AdtFar == "NRM" && Rbook[0].AdtFar == "NRM" && rtfBoolStatus == true) {
                        ...
                        e.RtfTotalPayDiv.html('Current Fare: <img src="' + UrlBase + 'images/crs.png" /> ' + parseInt(Obook[0].TotalFare + Rbook[0].TotalFare) + '/-');
                        totcurrentFare = parseInt(Obook[0].TotalFare + Rbook[0].TotalFare);
                    }
                        ...
                        if (e.d.ChangeFareO.TrackId == "0") {
                            ...
                            if (totfareOrigunal != totfareNew) {
                                ...
                                if (e.d.ChangeFareO.TrackId == "0") {
                                    ...
                                    window.location = UrlBase + "FlightDom/CustomerInfo.aspx?" + tackid;
                                }
        ...
        $('#ContinueCflt').click(function () {
            ...
            if (TrackId == "") {
                ...
                if ($.trim(trip).toUpperCase() == "I") {
                    window.location = UrlBase + "FlightInt/CustomerInfo.aspx?" + TrackId + ",I";
                }
                else {
                    window.location = UrlBase + "FlightDom/CustomerInfo.aspx?" + TrackId;
                }
            }
...
function DisplayMultipleFares(list, lnNoArray, secNum, fltName, IsRTrip, IsRTF, Index, tripF, mainLineNo) {
    ...
    for (var i = 0; i < lnn.length; i++) {
        ...
        //if (i == 0) {
        //    mainLineNo = OF.items[0].LineNumber;
        //}
        if (IsRTrip == true) {
            if(tripF=="O")
            {
            ...
            //res += '<div class="w100 rgt"><input type="radio" name="radioPrice" title="' + mainLineNo + '" id="' + OF.items[0].LineNumber + '_radio" value="' + OF.items[0].LineNumber + '" > &nbsp;<img class="gridViewToolTip cursorpointer" src="' + UrlBase + 'images/icons/faredetails.png" />' + OF.items[0].TotalFare + '&nbsp&nbsp&nbsp&nbsp' + OF.items[0].AdtFar + '</div>';
            ...
            //res += ' &nbsp;<img class="gridViewToolTip cursorpointer lft" src="' + UrlBase + 'images/icons/faredetails.png" />';
            if (i == 0) {
                //res += '<div class="w100 rgt"><input type="button"  value="Book"  class="falsebookbutton ' + mainLineNo + '" id="' + OF.items[0].LineNumber + '_falsebookbutton" /></div>';
                res += '<div class="w100 rgt"><input type="button"  value="Book" class="falsebookbutton ' + mainLineNo + '" id="' + mainLineNo + '_falsebookbutton" /></div>';
                // res += '<div class="w100 rgt"><input type="button"  value="Book_Dev2"  class="buttonfltbk" title="' + OF.items[0].LineNumber + '"  id="' + OF.items[0].LineNumber + '" /></div>';
            }
            //{
            ...
            //res += '<div class="large-3 medium-3 small-3 columns passenger">' + rnr;
            res += '<div>' + rnr;            
            //if (t.DisplayPromotionalFare(OF.items[0]) == '') {
            res += '<div class="gridViewToolTip cursorpointer lft"><img src="' + UrlBase + 'images/icons/faredetails.png"   />&nbsp;</div>';
            //}
            //else {
            //    res += '<div class="lft"><img src="' + UrlBase + 'images/icons/FamilyFriends.png" alt="F" title="Family and Friends" />&nbsp;</div>';
            //    res += '<div class="gridViewToolTip cursorpointer lft"><img src="' + UrlBase + 'images/icons/faredetails.png"   />&nbsp; </div>';                
            //}
            res += '<div class="gridViewToolTip1 hide"  title="' + OF.items[0].LineNumber + '_O" >ss</div>';
            ...
            // if (OF.items[0].ValiDatingCarrier != 'SG' && OF.items[0].ValiDatingCarrier != '6E' && OF.items[0].ValiDatingCarrier != 'G8')
            ...
            // res += '<div class="large-12 medium-12 small-12 columns spnDiscountShowHide" style="display:none;">Inv Price.' + OF.items[0].NetFare + '&nbsp;Incentive : ' + OF.items[0].TotDis + '</div>';
            res += '</div>';
