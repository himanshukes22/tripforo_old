...
ResHelper.prototype.GetUniqueAirline = function (result, cls, type) {
    ...
    for (var i = 0; i < marray.length; i++) {
        ...
        str += '<div class="lft w8"> <input value="' + marray[i] + '"  id="CheckboxA' + type + i + 1 + '"  type="checkbox"  /> </div><div class="lft w80" style="padding-top:0px;"><label for="' + marray[i] + '">' + marray[i] + '</label> </div> <div class="clear"> </div>';
            ...
            if (OB.items.length > 0) {
               ...
               .Select(function (item) { return item });
                ...
                if (OF.items.length > 0) {
                    ...
                    result += '<div class="large-2 medium-1 small-3 columns passenger" style="margin-top: 27px;">';
                   ...
                   // if (OB.items[0].ValiDatingCarrier != 'SG' && OB.items[0].ValiDatingCarrier != '6E' && OB.items[0].ValiDatingCarrier != 'G8')
                    ...
                    ///result += '';
                    if ($.trim(Provider).search("SFM") > 0) {
                        result += '<div class="price f20 lft colorp" style="color: #d63b05;"> <i clawaitMessagess="fa fa-inr" aria-hidden="true"></i>' + Math.ceil(OF.items[0].TotalFare / 2) + '</div>';
                    }
                    else {
                        result += '<div class="price f20 lft colorp" style="color: #d63b05;"> <i class="fa fa-inr" aria-hidden="true"></i>' + OF.items[0].TotalFare + '</div>';
                    }
                    //result += '<div class="clear"></div>';
                    ...
                    result += '<div class="w50 rgt"><input type="button"  value="Book Now"  class="buttonfltbk" title="' + OB.items[0].LineNumber + '"  id="' + OB.items[0].LineNumber + '" /></div>';
