...
ResHelper.prototype.ParallelCalling = function (c, IsNRMLRoundTrip, trip, providers, cacheData, cacheAirline, hidTextAirCode, rtfStatus) {
    ...
    async.parallel({
        One: function (callback) {
            if ($.trim(providers).search("G8") >= 0 && trip == "D" && mc != "rdbMultiCity") {
        ...
        Two: function (callback) {
            if ($.trim(providers).search("G8") >= 0 && IsNRMLRoundTrip == true && mc != "rdbMultiCity") {
                if ($.trim(cacheAirline).search("G8,") == -1) {
                    var prov = $.trim($.trim(providers).split('G8')[1].split('-')[0]);
        ...
        Four: function (callback) {
            if ($.trim(providers).search("SG") >= 0 && mc != "rdbMultiCity") {
        ...
        Five: function (callback) {
            if ($.trim(providers).search("SG") >= 0 && IsNRMLRoundTrip == true && mc != "rdbMultiCity") {
                if ($.trim(cacheAirline).search("SG,") == -1 || trip == "I") {
                    var prov = $.trim($.trim(providers).split('SG')[1].split('-')[0]);
        ...
        Sixteen: function (callback) {
            if ($.trim(providers).search("CPN") >= 0 && $.trim(providers).search("SG") >= 0 && mc != "rdbMultiCity" && trip == "D") {
        ...
        Seventeen: function (callback) {
            if ($.trim(providers).search("CPN") >= 0 && $.trim(providers).search("6E") >= 0 && mc != "rdbMultiCity" && trip == "D") {
        ...
        Eighteen: function (callback) {
            if ($.trim(providers).search("CPN") >= 0 && $.trim(providers).search("G8") >= 0 && mc != "rdbMultiCity" && trip == "D") {
