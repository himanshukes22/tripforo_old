            ...
            if (OB.items.length > 0) {
               ...
               .Select(function (item) { return item });
                ...
                if (OF.items.length > 0) {
                    ...
                    result += '<div class="large-2 medium-1 small-3 columns passenger" style="margin-top: 42px;margin-left: -42px;">';
...
function DisplayMultipleFares(list, lnNoArray, secNum, fltName, IsRTrip, IsRTF, Index, tripF) {
