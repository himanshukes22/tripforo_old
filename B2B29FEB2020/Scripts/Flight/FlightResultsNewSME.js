                ...
                if (OB.items.length > 0) {
                    ...
                    for (var obi = 0; obi < 1; obi++) { //OB.items.length; obi++) {
                        ...
                        if (k == 0) {
                            ...
                            else if (OB.items[obi].IsSMEFare) {
                                result += '<div class="w100 restext B2">SME Fare</div>';
                            }
                            //RoundTrip LEFT
                            result += '<div class="spnDiscountShowHide large-8 medium-8 small-8 columns" style="display:none;">Inv Price.' + OB.items[obi].NetFare + '&nbsp;Incentive : ' + OB.items[obi].TotDis + '</div>';
                    ...
                    if (OR.items.length > 0) {
                        ...
                        for (var obr = 0; obr < 1; obr++) { //OR.items.length; obr++) {
                            ...
                            if (k == 0) {
                                ...
                                else if (OR.items[obr].IsSMEFare) {
                                    result1 += '<div class="w100 restext B3">SME Fare</div>';
                                }
                                //RoundTrip Right
                                result1 += '<div class="spnDiscountShowHide large-8 medium-8 small-8 columns" style="display:none;">Inv Price.' + OR.items[obr].NetFare + '&nbsp;Incentive : ' + OR.items[obr].TotDis + '</div>';
               ...
               .Select(function (item) { return item });
                ...
                if (OF.items.length > 0) {
                    ...
                    if ($.trim(Provider).search("SFM") > 0) {
                        ...
                        result += '<div class="price f20 lft colorp"> <i class="fa fa-inr" aria-hidden="true"></i>' + OF.items[0].TotalFare + '</div>';
                    }
                    //result += '<div class="clear"></div>';
                ...
                else if (OB.items[0].IsSMEFare) {
                    result += '<div class="w100 restext B1">SME Fare</div>';
                }

                //result += '<div class="clear"></div>';
                result += '<span class="spnDiscountShowHide" style="display:none;"></br>Inv Price.' + OB.items[0].NetFare + '&nbsp;Incentive : ' + OB.items[0].TotDis + '</span></div>';
