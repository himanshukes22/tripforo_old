...
function DisplayMultipleFares(list, lnNoArray, secNum, fltName, IsRTrip, IsRTF, Index, tripF, mainLineNo) {
    ...
    var sector;
    res += '<div class="col-md-10" style="height:138px;overflow:hidden;overflow-y:scroll;z-index: 1011;">';
    ...
    for (var i = 0; i < lnn.length; i++) {
        ...
        if (i == 0) {
            faredet += '<div class="faredetailmaster" id="' + mainLineNo + '_faredetailmaster" style="position: relative; top: -28px; float: left;right: 670px;">' + rnr;
            
            //faredet += '<ul style="margin-top: -9px; width: 400px;">';
            faredet += '<div class="gridViewToolTip cursorpointer lft div_cls"><img src="' + UrlBase + 'images/icons/faredetails.png"   />&nbsp;</div>';
            faredet += '<div class="gridViewToolTip1 hide"  title="' + OF.items[0].LineNumber + '_O" ></div>';
            faredet += '<div class="lft div_cls"><a href="#" id="' + OF.items[0].LineNumber + 'Det" title="' + mainLineNo + '" rel="' + OF.items[0].LineNumber + '"  class="fltDetailslink"><img src="' + UrlBase + 'images/icons/information.png" class="cursorpointer" alt="Flight Details" title="Flight Details"   /></a></div>';
            faredet += '<div class="lft div_cls"><a href="#" id="' + OF.items[0].LineNumber + 'BagDet"  title="' + mainLineNo + '" rel="' + OF.items[0].LineNumber + '"  class="fltBagDetails"> <img src="../images/icons/baggage.png"   alt="Baggages Allowed"  class="cursorpointer"title="Baggages Allowed"></a></div>';
            faredet += '<span class="fareRuleToolTip cursorpointer lft" rel="FareRule_' + OF.items[0].LineNumber + '_O" title="' + mainLineNo + '" ><img src="' + UrlBase + 'images/fare-rules.png"  class="cursorpointer" alt="Fare Rule" title="Fare Rule" style="cursor:pointer;" /> &nbsp;</span><div class="fade"  title="' + OF.items[0].LineNumber + '_O" > &nbsp;</div>';
        ...
        faredet += '<div class="col-md-4 alldetailfaremaster" id="' + OF.items[0].LineNumber + '_master" style="display:none;">' + rnr;
        faredet += '<div  class="row"  >';
        faredet += '<div class="gridViewToolTip cursorpointer lft"><img src="' + UrlBase + 'images/icons/faredetails.png"   />&nbsp;</div>';
        faredet += '<div class="gridViewToolTip1"  title="' + OF.items[0].LineNumber + '_O" ></div>';
        faredet += '<div class="lft"><a href="#" id="' + OF.items[0].LineNumber + 'Det" title="' + mainLineNo + '" rel="' + OF.items[0].LineNumber + '"  class="fltDetailslink"><img src="' + UrlBase + 'images/icons/information.png" class="cursorpointer" alt="Flight Details" title="Flight Details"   /></a></div>';
        faredet += '<div class="lft"><a href="#" id="' + OF.items[0].LineNumber + 'BagDet"  title="' + mainLineNo + '" rel="' + OF.items[0].LineNumber + '"  class="fltBagDetails"> <img src="../images/icons/baggage.png"   alt="Baggages Allowed"  class="cursorpointer"title="Baggages Allowed"></a></div>';
        faredet += '<span class="fareRuleToolTip cursorpointer lft" rel="FareRule_' + OF.items[0].LineNumber + '_O" title="' + mainLineNo + '" ><img src="' + UrlBase + 'images/fare-rules.png"  class="cursorpointer" alt="Fare Rule" title="Fare Rule" style="cursor:pointer;" /> &nbsp;</span><div class="fade"  title="' + OF.items[0].LineNumber + '_O" > &nbsp;</div>';
