    ...
    async.parallel({
        One: function (callback) {
            if ($.trim(providers).search("G8") >= 0 && trip == "D" && mc != "rdbMultiCity") {
                ...
                if ($.trim(cacheAirline).search("G8,") == -1) {
                    ...
                    t.postData(t, "G8" + prov, c, IsNRMLRoundTrip, UrlBase + "AirHandler.ashx", false, false, true, $.trim(providers));
        ...
        Two: function (callback) {
            if ( IsNRMLRoundTrip == true && mc != "rdbMultiCity") {
                if (true) {
                    var prov = $.trim($.trim(providers).split('G8')[1].split('-')[0]);
                    t.postData(t, "G8" + prov, c, false, UrlBase + "AirHandler.ashx", false, true, true, $.trim(providers));
                    //t.Displayflter("G8", c, IsNRMLRoundTrip);
                }
                else {
                    t.DisplayCacheData("G8", IsNRMLRoundTrip, cacheData)
        ...
        Four: function (callback) {
            if ($.trim(providers).search("CPN") >= 0 && mc != "rdbMultiCity" && trip == "D") {
                if ($.trim(cacheAirline).search("CPN,") == -1 || trip == "I") {
                    ...
                    t.postData(t, "SG:SG", c, IsNRMLRoundTrip, UrlBase + "AirHandler.ashx", true, false, true, $.trim(providers));
