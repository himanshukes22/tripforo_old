...
function DisplayMultipleFares(list, lnNoArray, secNum, fltName, IsRTrip, IsRTF, Index, tripF, mainLineNo) {
    ...
    for (var i = 0; i < lnn.length; i++) {
        ...
        if (IsRTrip == true) {
            ...
            res += '<div class="row" style="position: inherit;margin-left: 1px;"><span style="font-size:10px;font-weight:900;color: #7a00ff;;">' + OF.items[0].AdtFar + '</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span> | </span><span style="font-size:12px;font-weight:400;color:#969696;">' + OF.items[0].AdtFareType + '</span> |  <i><img src="../Images/icons/airline-seat.png" style="width: 12px;margin-top: -5px;"/></i><span style="font-size:12px;color:orange;font-weight:400;"> ' + OF.items[0].AvailableSeats1 + ' left</span> &nbsp;&nbsp;<a><i><img src="../Images/icons/12-200.png" style="width:12px;    margin-top: -5px;"/></i></a></div><hr style="width: 253px;margin-left: 0px;border-bottom:1px dotted #848484;position: absolute;"><i><img src="../Images/icons/img_259251.png" style="width: 16px;margin-left: 254px;margin-top: -2px;"/></i></div>'
