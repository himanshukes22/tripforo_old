        ...
        $.ajax({
            ...
            success: function (e) {
               ...
               // $("#FareBreakupHederId").html("Loding Breakup ...");
                ...
                $('#' + e.d[0].LineNumber + '_').html(t.CreateFareBreakUp(e.d[0]));
                //$('#' + this.rel + '_').show();
                $('#' + e.d[0].LineNumber + '_').slideToggle();
                $('#' + this).hide();
                ...
                if (OB.items.length > 0) {
                    ...
                    for (var obi = 0; obi < 1; obi++) { //OB.items.length; obi++) {
                        ...
                        if (k == 0) {
                            ...
                            result += '<div class="">' + OB.items[obi].DepartureLocation + ' → ' + OB.items[obi].ArrivalLocation + '</div>';
            ...
            if (OB.items.length > 0) {
               ...
               .Select(function (item) { return item });
                ...
                if (OF.items.length > 0) {
                    ...
                    //Use Price Fare wise
                    result += '<div class="col-md-12 row" style="height:162px;">';
                ...
                //////div1 close
                result += '<div id="' + OB.items[0].LineNumber.toString() + '_" style="display:n o ne;width:100%;position: relative;top: -12px;"></div>';
                //result += '<div class="clear"></div>';
...
function DisplayMultipleFares(list, lnNoArray, secNum, fltName, IsRTrip, IsRTF, Index, tripF, mainLineNo) {
    ...
    for (var i = 0; i < lnn.length; i++) {
        ...
        if (i == 0) {
            faredet += '<div value="' + mainLineNo + '" class="' + mainLineNo + '_faredetailmasterall" id="' + OF.items[0].LineNumber + '_faredetailmaster" style="position: relative; top: -17px; float: left;right: 550px;width:550px;">' + rnr;
            ...
            faredet += '<div class="lft div_cls"><a href="#" id="' + OF.items[0].LineNumber + 'flt" title="' + mainLineNo + '" rel="' + mainLineNo + '"  class="gridViewToolTip"><span style="font-weight:600;color:orange !important;">Fare Details</span></a>  |  </div>';
            faredet += '<div class="gridViewToolTip1 lft hide" rel="' + mainLineNo + '" title="' + OF.items[0].LineNumber + '_O" ></div>';
            faredet += '<div class="lft div_cls"><a href="#" id="' + OF.items[0].LineNumber + 'Det" title="' + mainLineNo + '" rel="' + mainLineNo + '"  class="fltDetailslink"><span style="font-weight:600;color:orange !important;">Flight Details </span></a>  |  </div>';
            faredet += '<div class="lft div_cls"><a href="#" id="' + OF.items[0].LineNumber + 'BagDet"  title="' + mainLineNo + '" rel="' + mainLineNo + '"  class="fltBagDetails"><span style="font-weight:600;color:orange !important;">Baggage</span></a>  |  </div>';
            faredet += '<span class="fareRuleToolTip cursorpointer lft" rel="FareRule_' + mainLineNo + '_O" title="' + mainLineNo + '" style="font-weight:600;color:orange !important;">Cancellation</span>  |  <div class="fade" title="' + mainLineNo + '_O" > &nbsp;</div>';
        ...
        faredet += '<div value="' + mainLineNo + '" class="' + mainLineNo + '_faredetailmasterall" id="' + OF.items[0].LineNumber + '_master" style="display:none;position: relative; top: -17px; float: left;right: 550px;">' + rnr;
        ...
        faredet += '<div class="lft"><a href="#" id="' + OF.items[0].LineNumber + 'Det" title="' + mainLineNo + '" rel="' + mainLineNo + '"  class="fltDetailslink"><span style="font-weight:600;color:orange !important;">Flight Details  |  </span></a></div>';
        faredet += '<div class="lft"><a href="#" id="' + OF.items[0].LineNumber + 'BagDet"  title="' + mainLineNo + '" rel="' + mainLineNo + '"  class="fltBagDetails"><span style="font-weight:600;color:orange !important;">Baggage  |  </span></a></div>';
        faredet += '<span class="fareRuleToolTip cursorpointer lft" rel="FareRule_' + mainLineNo + '_O" title="' + mainLineNo + '" style="font-weight:600;color:orange !important;">Cancellation  |  </span><div class="fade" title="' + mainLineNo + '_O" > &nbsp;</div>';
