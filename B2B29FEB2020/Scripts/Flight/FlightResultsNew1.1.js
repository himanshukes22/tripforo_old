    ...
    $('.fltDetailslink').click(function (event) {
        ...
        if (this.rel != null) {
           ...
           .Select(function (item) { return item });
            var str1 = '<div>';
            if (O.items.length > 0) {
                str1 += '<div class="depcity"><span style="font-size:20px; float:right; position:relative; top:-5px; right:-5px; cursor:pointer;" onclick="Close(\'' + this.rel + '_\');" title="Click to close Details">X</span><div class="large-12 medium-12 small-12"><span class="f16">' + O.items[0].DepartureCityName + '-' + O.items[O.items.length - 1].ArrivalCityName + '</span>&nbsp;' + e.MakeupTotDur(O.items[0].TotDur) + '</div><div class="clear"></div>';
                for (var i = 0; i < O.items.length; i++) {
                    ...
                    //str1 += '<div class="layover"> + <span> <i class="ico ico-time">&nbsp;</i> Layover: <strong>Muscat (MCT) </strong> </span> <span class="pipe"> | </span> <time> Time: <strong>01h 35m</strong> </time>  </div>'
                }
            }
            if (R.items.length > 0) {
                str1 += '<div>dfgdfgdfg </div>'
    ...
    $('.fltBagDetailsR').click(function (event) {
        ...
        if ($(this).attr("rel") != null) {
           ...
           .Select(function (item) { return item });
            ...
            if (O.items.length > 0) {
                str1 += '<div class="depcity">';
                str1 += '<table class="w100 f12" style="padding: 10px; background: #ffffff;  border: 6px solid #eee;"><tr><td class="f16 bld w50">Sector</td><td class="f16 bld">Baggage Quantity</td></tr>';
                for (var i = 0; i < O.items.length; i++) {
                    str1 += '<tr><td>' + O.items[i].DepartureCityName + '-' + O.items[i].ArrivalCityName + '(' + O.items[i].MarketingCarrier + ' - ' + O.items[i].FlightIdentification + ')</td>'
                    str1 += '<td>' + e.BagInfo(O.items[i].BagInfo) + '</td></tr>';
            ...
            if (R.items.length > 0) {
                str1 += '<div class="depcity1">';
                str1 += '<table class="w100 f12" style="padding: 10px; background: #ffffff;   border: 6px solid #eee;">';
                for (var j = 0; j < R.items.length; j++) {
                    str1 += '<tr><td class="w50">' + R.items[j].DepartureCityName + '-' + R.items[j].ArrivalCityName + '(' + R.items[j].MarketingCarrier + ' - ' + R.items[j].FlightIdentification + ')</td>'
                    str1 += '<td>' + e.BagInfo(R.items[j].BagInfo) + '</td></tr>';
                }
...
ResHelper.prototype.ParallelCalling = function (c, IsNRMLRoundTrip, trip, providers, cacheData, cacheAirline, hidTextAirCode, rtfStatus) {
    ...
    async.parallel({
        ...
        Fifteen: function (callback) {
            ...
            if ($.trim(providers).search("OF") >= 0 && trip == "D") {
        ...
        for (var i = 1; i <= LnOb; i++) {
            ...
            if (OB.items.length > 0) {
                ...
                for (var obi = 0; obi < 1; obi++) { //OB.items.length; obi++) {
                    ...
                    result += '</div>';
                    result += '<div class="large-8 medium-8 small-9 columns">';
                    result += '<div class="large-4 medium-4 small-6 columns">';
                    ...
                    if (k == 0) {
                        result += '<div class="f16 bld blue">' + t.MakeupTotDur(OB.items[obi].TotDur) + "hrs" + '</div>';
                    ...
                    if (k == 0) {
                        ...
                        if (k == 0) {
                            ...
                            //result += '<div class="passenger" style="color:red">' + OB.items[obi].AdtFar + '</div>';
                        }
                        result += '</div>';
                        ...
                        result += '<div class="large-6 medium-12 small-12 columns rgt">';
                        ...
                        if (k == 0) {
                            ...
                            result += '<div class="bld colorp italic lft " style="white-space:nowrap;">' + rnr + '</div>'; //+ OB.items[obi].AdtFareType
                        ...
                        result += '</div>';
                        result += '<div class="clear"></div>';
                        result += '<div class="passenger w100 restext">' + OB.items[obi].AdtFar + '</div>';
                        result += '<div class="clear"></div>';
                    }
                    k++;
            ...
            for (var i = 1; i <= LnOb; i++) {
                ...
                if (OR.items.length > 0) {
                    ...
                    for (var obr = 0; obr < 1; obr++) { //OR.items.length; obr++) {
                        ...
                        result1 += '</div>';
                        result1 += '<div class="large-8 medium-8 small-9 columns">';
                        result1 += '<div class="large-4 medium-4 small-6 columns">';
                        ...
                        if (k == 0) {
                            result1 += '<div class="f16 bld blue"> ' + t.MakeupTotDur(OR.items[obr].TotDur) + "hrs" + '</div>';
                        ...
                        if (k == 0) {
                            ...
                            if (k == 0) {
                                ...
                                //result1 += '<div class="passenger" style="color:red">' + OR.items[obr].AdtFar + '</div>';
                            }
                            result1 += '</div>';
                            result1 += '</div>';
                           
                            result1 += '<div class="passenger w100 restext">' + OR.items[obr].AdtFar + '</div>';
                        ...
                        if (k == 0) {
                            ...
                            result1 += ' <div class="large-6 medium-12 small-12 columns rgt" >'
                            result1 += '<div class="bld colorp lft italic" style="white-space:nowrap;">' + rnr + '</div>';
                            result1 += ' <div class="" >'
                            //OR.items[obr].AdtFareType 
    ...
    if (resultArray[0].length > 0) {
        ...
        for (var i = 1; i <= LnOb; i++) {
            ...
            if (OF.items.length > 0) {
                ...
                result += '<div class="f16 bld blue">' + t.MakeupTotDur(OF.items[0].TotDur) + "hrs" + '</div>';
            ...
            result += '<div class="w100 restext">' + OB.items[0].AdtFar + '</div>';
            result += '<div class="clear"></div>';
            result += '</div>';
            ...
            for (var ff = 2; ff <= ft; ff++) {
                ...
                if (RF.items.length > 0) {
                    ...
                    result += '</div>';
                    result += '<div class="large-2 medium-2 small-3 columns">';
                    result += '<div class="f16">' + t.MakeupTotDur(RF.items[0].TotDur) + ' &nbsp;</div>';
...
ResHelper.prototype.DisplaySelectedFlight = function (objFlt, type) {
    ...
    if (objFlt.length > 1) {
        ...
        string += '<div class="large-6 medium-6 small-6 columns">' + objFlt[0].DepartureCityName + ' - ' + objFlt[objFlt.length - 1].ArrivalCityName + '<div class="passenger clear f16">' + objFlt[0].DepartureTime + ' - ' + objFlt[objFlt.length - 1].ArrivalTime + '</div><div class="passenger clear">' + objFlt[0].Departure_Date + '&nbsp;&nbsp;<img src="../images/duration.png" class="w10" />&nbsp;&nbsp;' + objFlt[0].TotDur + '</div></div>';
        if (type == "SRF") {
        ...
        string += '<div class="large-6 medium-6 small-6 columns">' + objFlt[0].DepartureCityName + ' - ' + objFlt[0].ArrivalCityName + '<div class="passenger clear f16">' + objFlt[0].DepartureTime + ' - ' + objFlt[0].ArrivalTime + '</div><div class="passenger clear">' + objFlt[0].Departure_Date + '&nbsp;&nbsp;<img src="../images/duration.png" class="w10" />&nbsp;&nbsp;' + objFlt[0].TotDur + '</div></div>';
