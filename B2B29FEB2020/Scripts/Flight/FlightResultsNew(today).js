...
$(document).ready(function () {
    ...
    $(document).on("click", "input[name='radioPrice']", function (e) {
        ...
        $('.buttonfltbk').attr('title', "selectfare");
        $('#' + this.title + '_booknow').attr('title', this.value);
    });
    ...
    e.NextDaySrch.click(function (event) {
        ...
        if (Trip == "D") {
            ...
            try {
                $.ajax({
                    url: UrlBase + "FltSearch1.asmx/GetMUForPage",
                    data: "{ 'name': 'Domestic/Result.aspx.aspx'}",
                    dataType: "json",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                        ...
                        if (resUm != null && resUm != "") {
                            ...
                            window.location.href = UrlBase + "Domestic/Result.aspx.aspx?" + dataString;
                        }
                    },
                    error: function (e, t, n) {
                        // alert(t)
...
ResHelper.prototype.Book = function (result) {
    ...
    e.bookO.click(function () {
        var lineNumBookNow = $.trim($(this).attr("title"));
        var lineNoBookNow = $.trim(lineNumBookNow.split('api')[0]);
        if (lineNoBookNow == "selectfare" || lineNoBookNow == " ") {
                ...
                $.ajax({
                    ...
                    success: function (e) {
                        ...
                        if (e.d.Response == null) {
                            str1 += '<div class="depcity"><span style="font-size:20px; float:right; position:relative; top:-5px; right:-15px; cursor:pointer; height:1px;" onclick="Close(\'' + lineNum[0] + '_\');" title="Click to close Details"><i class="fa fa-times-circle"></i></span><div></div>';
...
ResHelper.prototype.CreateFareBreakUp = function (e) {
    ...
    strResult ='<div><span style="font-size:20px; float:right; position:relative; top:-5px; right:-5px; cursor:pointer;" onclick="Close(\'' + e.LineNumber + '_\');" title="Click to close Details"><i class="fa fa-times-circle"></i></span></div>'
    ...
    $('.fltDetailslink').click(function (event) {
        ...
        if (this.rel != null) {
            ...
            if (O.items.length > 0) {
                ...
                str1 += '<div class="depcity"><span style="font-size:20px; float:right; position:relative; top:-5px; right:-5px; cursor:pointer;" onclick="Close(\'' + this.rel + '_\');" title="Click to close Details"><i class="fa fa-times-circle"></i></span><div class="large-12 medium-12 small-12"><span class="f16">' + O.items[0].DepartureCityName + '-' + O.items[O.items.length - 1].ArrivalCityName + '</span>&nbsp;' + totDur + '</div><div class="clear"></div>';
                for (var i = 0; i < O.items.length; i++) {
                    ...
                    str1 += '<div class="large-2 medium-2 small-2 columns bld"><span style="position: relative;right: -59px;">' + ftme + '</span><br><div class="flt-dur"><div class="dot"></div><div class="dot-plan"><i class="fa fa-plane" style="background: #fff;color: #b8b8b8;"></i></div><div class="dot2"></div></div></div>';
    ...
    $('.fltBagDetails').click(function (event) {
        ...
        if (this.rel != null) {
           ...
           .Select(function (item) { return item });
            var str1 = '<div>';
            if (O.items.length > 0) {
                str1 += '<div class="depcity"><span style="font-size:20px; float:right; position:relative; top:-5px; right:-15px; cursor:pointer; height:1px;" onclick="Close(\'' + this.rel + '_\');" title="Click to close Details"><i class="fa fa-times-circle"></i></span><div></div>';
                    ...
                    for (var obi = 0; obi < 1; obi++) { //OB.items.length; obi++) {
                        ...
                        if (t.CheckMultipleCarrier(OB.items) == true) {
                            ...
                            if ((OB.items[obi].MarketingCarrier == '6E') && ($.trim(OB.items[obi].sno).search("INDIGOCORP") >= 0)) {
                                ...
                                result += '<div class="airlineImage">FlyWidUs Fare</div>';
                            }
                            else {
                        ...
                        if (k == 0) {
                            ...
                            if (k == 0) {
                                ...
                                else if (OB.items[obi].AdtFar != "NRM") {
                                    FAirType0 = OB.items[obi].AdtFar;
                                }
                                else {
                                    FAirType0 = "NRM";
                                }
                        ...
                        if (k == 0) {
                            ...
                            if ($.trim(Provider).search("SFM") > 0 && (OB.items[obi].MarketingCarrier == "SG" || OB.items[obi].MarketingCarrier == "6E" || OB.items[obi].MarketingCarrier == "G8" || OB.items[obi].MarketingCarrier == "UK888") && OB.items[obi].Trip == "D") {
                                result += '<div class="f20 rgt colorp"><i class="fa fa-inr" aria-hidden="true"></i>' + OB.items[obi].NetFareSRTF + '</div>';
                                ////Devesh SRTF LEFT PANEL
                            }
                            else {
                                result += '<div class="f20 rgt colorp"><i class="fa fa-inr" aria-hidden="true"></i>' + OB.items[obi].TotalFare + '</div>';
                        ...
                        for (var obr = 0; obr < 1; obr++) { //OR.items.length; obr++) {
                            ...
                            if (t.CheckMultipleCarrier(OR.items) == true) {
                                ...
                                if ((OR.items[obr].MarketingCarrier == '6E') && ($.trim(OR.items[obr].sno).search("INDIGOCORP") >= 0)) {
                                    ...
                                    result1 += '<div class="airlineImage">FlyWidUs Fare</div>';
                                }
                                else {
                            ...
                            if (k == 0) {
                                ...
                                if (k == 0) {
                                    ...
                                    else if (OR.items[obr].AdtFar != "NRM") {
                                        FAirType2 = OR.items[obr].AdtFar;
                                    }
                                    else {
                                        FAirType2 = "NRM";
                                    }
                            ...
                            result1 += '</div>';
                            if (k == 0) {
                                result1 += '<div class="large-2 medium-2 small-8 columns right">';
                                ...
                                if ($.trim(Provider).search("SFM") > 0 && (OR.items[obr].MarketingCarrier == "SG" || OR.items[obr].MarketingCarrier == "6E" || OR.items[obr].MarketingCarrier == "G8" || OR.items[obr].MarketingCarrier == "UK888") && OR.items[obr].Trip == "D") {
                                    result1 += '<div class="price f20 rgt colorp"><i class="fa fa-inr" aria-hidden="true"></i>' + OR.items[obr].NetFareSRTF + '</div>';
                                    //Devesh SRTF RIGHT PANEL
                                }
                                else {
                                    result1 += '<div class="price f20 rgt colorp"><i class="fa fa-inr" aria-hidden="true"></i>' + OR.items[obr].TotalFare + '</div>';
                                }
            ...
            if (OB.items.length > 0) {
               ...
               .Select(function (item) { return item });
                ...
                if (OF.items.length > 0) {
                    ...
                    result += '<div class="large-2 medium-1 small-3 columns passenger" style="margin-top: 41px;margin-left: -42px;">';
                    ...
                    result += '<div class="w100 rgt"><input type="button"  value="Book_Dev3"  class="buttonfltbk" title="selectfare"  id="' + OB.items[0].LineNumber + '_booknow" /></div>';
                    //Use Price Fare wise
                    result += '<div class="row">';
...
function displayBIn(id, d) {
   ...
   .Select(function (item) { return item });
    ...
    var str1 = '<div>';
    if (O.items.length > 0) {
        str1 += '<div class="depcity"><span style="font-size:20px;display:none; float:right; position:relative; top:-5px; right:-15px; cursor:pointer; height:1px;" onclick="Close(\'' + this.rel + '_\');" title="Click to close Details"><i class="fa fa-times-circle"></i></span><div></div>';
        str1 += '<table class="w100 f12"><tr><td  class="w50 f16 bld">Sector</td><td class="f16 bld">Baggage Quantity</td></tr>';
        for (var i = 0; i < O.items.length; i++) {
            str1 += '<tr><td>' + O.items[i].DepartureCityName + '-' + O.items[i].ArrivalCityName + '(' + O.items[i].MarketingCarrier + ' - ' + O.items[i].FlightIdentification + ')</td>'
...
function DisplayMultipleFares(list, lnNoArray, secNum, fltName, IsRTrip, IsRTF, Index, tripF, mainLineNo) {
    ...
    for (var i = 0; i < lnn.length; i++) {
        ...
        if (IsRTrip == true) {
            if (tripF == "O") {
                res += '<input type="radio" name="O" class="' + mainLineNo + '" value="' + OF.items[0].LineNumber + '" />' + OF.items[0].TotalFare + '&nbsp&nbsp&nbsp&nbsp' + OF.items[0].DisplayFareType;
            }
            else if (tripF == "R") {
                res += '<input type="radio" name="R" value="' + OF.items[0].LineNumber + '" />' + OF.items[0].TotalFare + '&nbsp&nbsp&nbsp&nbsp' + OF.items[0].DisplayFareType;
            }
            ...
            res += '<div class="row" style="position: inherit;margin-left: 1px;"><span style="font-size:10px;font-weight:900;color: #7a00ff;;">' + OF.items[0].DisplayFareType + '</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span> | </span><span style="font-size:12px;font-weight:400;color:#969696;">' + OF.items[0].AdtFareType + '</span> |  <i><img src="../Images/icons/airline-seat.png" style="width: 12px;margin-top: -5px;"/></i><span style="font-size:12px;color:orange;font-weight:400;"> ' + OF.items[0].AvailableSeats1 + ' left</span> &nbsp;&nbsp;<a><i><img src="../Images/icons/12-200.png" style="width:12px;    margin-top: -5px;"/></i></a></div><hr style="width: 253px;margin-left: 0px;border-bottom:1px dotted #848484;position: absolute;"><i><img src="../Images/icons/img_259251.png" style="width: 16px;margin-left: 254px;margin-top: -2px;"/></i></div>'
            ...
            res += '<div class="col-md-2">';
                ...
                if (i == 0) {
                    faredet += '<div value="' + mainLineNo + '" class="' + mainLineNo + '_faredetailmasterall" id="' + OF.items[0].LineNumber + '_faredetailmaster" style="position: relative; top: -17px; float: left;right: 550px; width:501px;">';
                ...
                faredet += '<div value="' + mainLineNo + '" class="' + mainLineNo + '_faredetailmasterall" id="' + OF.items[0].LineNumber + '_master" style="display:none;position: relative; top: -17px; float: left;right: 550px;width:501px;">' + rnr;
