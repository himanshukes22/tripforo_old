...
function DisplayMultipleFares(list, lnNoArray, secNum, fltName, IsRTrip, IsRTF, Index, tripF, mainLineNo) {
    ...
    if (IsRTrip == true) {
        ...
        if (tripF == "O") {
            res += '<div class="col-md-2" style="height: 75px;overflow-y: scroll;z-index: 800;width: 28%;left: -44px;font-weight: 600;">';
        }
        else { res += '<div class="col-md-2" style="height: 75px;overflow-y: scroll;z-index: 800;width: 28%;left: -12px;font-weight: 600;">'; }
    }
