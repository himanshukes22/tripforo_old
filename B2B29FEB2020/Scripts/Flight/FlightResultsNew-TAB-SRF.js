                ...
                for (var obi = 0; obi < 1; obi++) { //OB.items.length; obi++) {
                    ...
                    if (k == 0) {
						...
						if ($.trim(Provider).search("SFM") > 0  && ( OB.items[obi].MarketingCarrier=="SG" ||  OB.items[obi].MarketingCarrier=="6E" ||  OB.items[obi].MarketingCarrier=="G8" ||  OB.items[obi].MarketingCarrier=="UK888") && OB.items[obi].Trip =="D") {
						 ...
						 result += '<div class="f20 rgt colorp"><i class="fa fa-inr" aria-hidden="true"></i><span id="Left_' + OB.items[obi].LineNumber +OB.items[obi].MarketingCarrier+ '" >' + OB.items[obi].NetFareSRTF + '</span><span style="color: #ed1922;" id="OLDSRFO_' + OB.items[obi].LineNumber +OB.items[obi].MarketingCarrier+ '" ></span></div>';
						 ////Devesh SRTF LEFT PANEL
						}
						else{
						   // result += '<div class="f20 rgt colorp"><i class="fa fa-inr" aria-hidden="true"></i>' + OB.items[obi].TotalFare + '</div>';
							result += '<div class="f20 rgt colorp"><i class="fa fa-inr" aria-hidden="true"></i><span id="Left_' + OB.items[obi].LineNumber +OB.items[obi].MarketingCarrier+ '" >' + OB.items[obi].TotalFare + '</span><span style="color: #ed1922;" id="OLDSRFO_' + OB.items[obi].LineNumber +OB.items[obi].MarketingCarrier+ '" ></span></div>';
                  ...
                  //  result1 += '<div class="list-itemR">';
                    ...
                    for (var obr = 0; obr < 1; obr++) { //OR.items.length; obr++) {
					   ...
					   if ($.trim(Provider).search("SFM") > 0  && ( OR.items[obr].MarketingCarrier=="SG" ||  OR.items[obr].MarketingCarrier=="6E" ||  OR.items[obr].MarketingCarrier=="G8" ||  OR.items[obr].MarketingCarrier=="UK888") && OR.items[obr].Trip =="D") {						
						   ...
						   result1 += '<div class="price f20 rgt colorp"><i class="fa fa-inr" aria-hidden="true"></i><span id="Right_' + OR.items[obr].LineNumber + OR.items[obr].MarketingCarrier + '" >' + OR.items[obr].NetFareSRTF + '</span><span style="color: #ed1922;" id="OLDSRFR_' + OR.items[obr].LineNumber + OR.items[obr].MarketingCarrier + '" ></span></div>';
						   ...
						   result1 += '<div class="price f20 rgt colorp"><i class="fa fa-inr" aria-hidden="true"></i><span id="Right_' + OR.items[obr].LineNumber + OR.items[obr].MarketingCarrier + '" >' + OR.items[obr].TotalFare + '</span><span style="color: #ed1922;" id="OLDSRFR_' + OR.items[obr].LineNumber + OR.items[obr].MarketingCarrier + '" ></div>';
						}
...
ResHelper.prototype.GetSelectedRoundtripFlight = function (resultArray) {
    ...
    $("input:radio").click(function () {
        ...
        if (this.name == "O" || this.name == "RO") {
			...
			$('#hdnSRFPriceLineNoO').val(ORTFLineNo+ORTFVC);
			$('#hdnSRFAircodeO').val(ORTFVC);
            if (Obook[0].LineNumber.search('SFM') > 0) {
