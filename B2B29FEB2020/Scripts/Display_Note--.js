            ...
            if (status == 0) {
                ...
                if (parsedObject[i].TypeOfmsg == "PopUP") {
                    ...
                    if (pageurlname.toLowerCase() == parsedObject[i].PageName.toLowerCase() || parsedObject[i].PageName == '') {
                        ...
                        htmlsdr += '<div class="content"><span style="font-family:"Times New Roman", Times, serif;"><span style="padding-left:160px; font-weight:bold; text-decoration:underline;color:red;font-size:15px;">' + parsedObject[i].Title.trim() + ' </span><br />    Notice: ' + parsedObject[i].Message.trim() + '</span></div>';
                        htmlsdr += '</div>';
                    }
                }
                if (parsedObject[i].TypeOfmsg == "marquee") {
                    htmlmaq += ' Tittle:  ' + parsedObject[i].Title.trim() + '     Notice: ' + parsedObject[i].Message.trim() + ",  ";
                }
            }
