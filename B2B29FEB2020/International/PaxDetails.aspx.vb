...
Partial Class FlightInt_CustomerInfo
    ...
    Private Function fareBreakupfun(ByVal IntAirDt As DataTable) As String
        Try
            ...
            strFare = strFare & "<div class='pr-l'>Adult Fare</div>"
            'strFare = strFare & "<td width='93'>" & fareHashtbl("AdtBFare") & "</td>"
            strFare = strFare & "<div class='pr-r'><span>₹ " & IntAirDt.Rows(0)("AdtBFare") & "</span></div>"
            strFare = strFare & "</div>"
            strFare = strFare & "<div class='pr'>"
            ...
            strFare = strFare & "<div class='pr-r'><span>₹ " & (Convert.ToInt32(IntAirDt.Rows(0)("AdtFare")) + tcperpax) & "</span></div>"
            strFare = strFare & "</div>"
            ...
            If Child > 0 Then
                ...
                strFare = strFare & "<div class='w100 lft'>"
                strFare = strFare & "<div class='pr'>"
                strFare = strFare & "<div class='pr-l'>Child Fare</div>"
                'strFare = strFare & "<td width='130'>" & fareHashtbl("ChdBFare") & "</td>"
                strFare = strFare & "<div class='pr-r'><span>₹ " & IntAirDt.Rows(0)("ChdBFare") & "</span></div>"
                strFare = strFare & "</div>"
                strFare = strFare & "<div class='pr'>"
                strFare = strFare & "<div class='pr-l'>Fuel Surcharge </div>"
                strFare = strFare & "<div class='pr-r'><span>₹ " & yq & "</span></div>"
                ...
                strFare = strFare & "<div class='pr-r'><span>₹ " & (IntAirDt.Rows(0)("ChdFare") + tcperpax) & "</span></div>"
                strFare = strFare & "</div>"
                'strFare = strFare & "<div class='clear1'></div>"
                'strFare = strFare & "<div class='hr'></div>"
                strFare = strFare & "</div>"
            ...
            If Infant > 0 Then
                ...
                strFare = strFare & "<div class='w100 lft'>"
                strFare = strFare & "<div class='pr'>"
                strFare = strFare & "<div class='pr-l'>Infant Fare</div>"
                'strFare = strFare & "<td width='130'>" & fareHashtbl("InfBFare") & "</td>"
                strFare = strFare & "<div class='pr-r'><span>₹ " & IntAirDt.Rows(0)("InfBFare") & "</span></div>"
                strFare = strFare & "</div>"
                strFare = strFare & "<div class='pr'>"
                strFare = strFare & "<div class='pr-l'>Tax</div>"
                ...
                strFare = strFare & "<div class='pr-r'><span>₹ " & IntAirDt.Rows(0)("InfFare") & "</span></div>"
                strFare = strFare & "</div>"
                'strFare = strFare & "<div class='clear1'></div>"
                'strFare = strFare & "<div class='hr'></div>"
                strFare = strFare & "</div>"
            ...
            strFare = strFare & "<div class='pr-r'><span>₹ " & IntAirDt.Rows(0)("SrvTax") & "</span></div>"
            strFare = strFare & "</div>"
            ...
            If (IntAirDt.Rows(0)("IsCorp") = True) Then
                ...
                strFare = strFare & "<div class='pr-r'><span>₹ " & IntAirDt.Rows(0)("TOTMGTFEE") & "</span></div>"
                strFare = strFare & "</div>"
            Else
                strFare = strFare & "<div class='pr'>"
                strFare = strFare & "<div class='pr-l'>Transaction Fee</div>"
                'strFare = strFare & "<td>" & fareHashtbl("TFee") & "</td>"
                strFare = strFare & "<div class='pr-r'><span>₹ " & IntAirDt.Rows(0)("TFee") & "</span></div>"
                strFare = strFare & "</div>"
                strFare = strFare & "<div class='pr'>"
            ...
            strFare = strFare & "<div class='pr-l' style='font-size:16px; color:red;'>Total Fare</div>"
            'strFare = strFare & "<td>" & fareHashtbl("totFare") & "</td>"
            strFare = strFare & "<div class='pr-r'><span>₹ " & IntAirDt.Rows(0)("totFare") & "</span></div>"
            strFare = strFare & "</div>"
            strFare = strFare & "<div id='trnetfare' style='display:none'>"

            strFare = strFare & "<div class='pr-l'>Commission</div>"
            strFare = strFare & "<div class='pr-r'><span>₹ " & IntAirDt.Rows(0)("DisCount") & "</span></div>"
            ...
            strFare = strFare & "<div class='pr-l'>Net Fare</div>"
            'strFare = strFare & "<td>" & fareHashtbl("netFare") & "</td>"
            strFare = strFare & "<div class='pr-r'><span>₹ " & IntAirDt.Rows(0)("netFare") & "</span></div>"
            strFare = strFare & "</div>"
                    ...
                    If AgencyDs.Tables(0).Rows(0)("Agent_Status").ToString.Trim <> "NOT ACTIVE" And AgencyDs.Tables(0).Rows(0)("Online_tkt").ToString.Trim <> "NOT ACTIVE" Then
                        ...
                        If FltHdr.Tables.Count > 0 Then
                            If FltHdr.Tables(0).Rows.Count = 0 Then
                                ...
                                If (VCOB = "SG" Or VCOB = "6E" Or VCOB = "FZ" Or VCOB = "G8" Or VCOB = "G9" Or VCOB = "AK" Or VCOB = "I5" Or VCOB = "D7" Or VCOB = "FD" Or VCOB = "QZ" Or VCOB = "Z2" Or VCOB = "XJ" Or VCOB = "XT" Or VCOB = "DJ") And InStr(VCOBSPL, "Spl") = 0 Or Prvdr = "TB" Or Prvdr = "YA" Or VCOB = "IX" Or Prvdr = "TQ" Then
                ...
                If (String.IsNullOrEmpty(seat)) Then
                    If pr = "IX" Then
                        ...
                        Else
                         ...
                         "ADT", DOB, txt_ANumber.Text.Trim(), txt_AAirline.Value.Trim(), Ddl_A_Meal_Obhid.Value, SeattypeAhid.Value,
...
LAB2:
        ...
        Try
            ...
            If (MBPR > 0 Or (VC = "SG" AndAlso objInputs.Cabin = "BUSINESS")) Then
                If (FltDs.Tables(0).Rows(0)("Provider") = "TQ") Then
                    ...
                    Dim CredencialDs As DataSet = objSql.GetCredentials("TQ", "", "D")
            ...
            Else
                If (VC = "AK" Or VC = "I5" Or VC = "D7" Or VC = "FD" Or VC = "QZ" Or VC = "Z2" Or VC = "XJ" Or VC = "XT" Or VC = "DJ") And FltDs.Tables(0).Rows(0)("Provider") <> "TQ" Then
                    Dim objAirAsia As New GALWS.AirAsia.AirAsiaSellSSR_AssignSeat()
                    Dim CredencialDs As DataSet = objSql.GetCredentials("AK", Convert.ToString(FltDs.Tables(0).Rows(0)("RESULTTYPE")), "I")
                    SSRPRICE = objAirAsia.SellSSR(CredencialDs, FltDs.Tables(0), ConfigurationManager.ConnectionStrings("myAmdDB").ConnectionString, MBDT.Tables(0), Xml)
                    Try
                ...
                ElseIf (VC = "G9" And FltDs.Tables(0).Rows(0)("Provider") <> "TQ") Then
                    Dim objAirArabiaia As New GALWS.AirArabia.AirArabiaBooking()
                    Dim CredencialDs As DataSet = objSql.GetCredentials("G9", Convert.ToString(FltDs.Tables(0).Rows(0)("RESULTTYPE")), "I")
                    SSRPRICE = objAirArabiaia.PricingWithMealBaggege(CredencialDs, FltDs.Tables(0), MBDT.Tables(0), PaxDs.Tables(0), txtGstNo.Text.Trim(), Xml)
  ...
  Dim IFLT As FlightCommonBAL = New FlightCommonBAL(ConfigurationManager.ConnectionStrings("myAmdDB").ConnectionString)
                    ...
                    SeatListO = IFLT.SeatDetails(FltDs.Tables(0).Rows(0)("Track_id").ToString.Trim.ToUpper)
                        Dim objItqApi As New GALWS.ITQAirApi.BookingAndAddPassanger()
                        Dim CredencialDs As DataSet = objSql.GetCredentials("TQ", "", "I")
                        SSRPRICE = objItqApi.AddPassanger(GSTdet.Tables(0), CredencialDs.Tables(0).Rows(0)("BkgServerUrlOrIP").ToString(), txt_MobNo.Text, txt_Email.Text, FltDs.Tables(0), MBDT.Tables(0), PaxDs, AgencyDs, OriginalTF,SeatListO, Xml)
                    Catch ex As Exception
                        SSRPRICE = "FAILURE"
                    End Try
