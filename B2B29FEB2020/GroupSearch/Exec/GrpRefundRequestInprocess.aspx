<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAfterLogin.master" AutoEventWireup="true" CodeFile="GrpRefundRequestInprocess.aspx.cs" Inherits="GroupSearch_Exec_GrpRefundRequestInprocess" %>
                    ...
                    <asp:GridView ID="GridRefundRequest" runat="server" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="RequestID">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkupdate" runat="server" Text='<%#Eval("RefundRequestID") %>' ForeColor="Red"
                                        CommandName="lnkupdate" Font-Bold="true" Font-Size="11px" CommandArgument='<%#Eval("RequestedID") %>'
                            ...
                            <asp:TemplateField HeaderText="Booking ID">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblrefndval" runat="server" Visible="false"  Text='<%#Eval("RefundRequestID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
